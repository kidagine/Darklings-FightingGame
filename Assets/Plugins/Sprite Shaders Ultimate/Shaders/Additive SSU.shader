...
Shader "Sprite Shaders Ultimate/Additive SSU"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float MyCustomExpression16_g11723( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11749( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float3 MyCustomExpression115_g11759( float3 In, float3 From, float3 To, float Fuzziness, float Range )
			{
			...
			float MyCustomExpression16_g11804( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			v2f vert( appdata_t IN  )
			{
				...
				#ifdef _ENABLESQUISH_ON
				float2 break77_g11868 = fixedUV475;
				float2 appendResult72_g11868 = (float2(( _SquishStretch * ( break77_g11868.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g11868.y + _SquishFlip ) * -_SquishSquish )));
				float2 staticSwitch198 = ( appendResult72_g11868 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g11871 = staticSwitch198;
				#ifdef _TOGGLECUSTOMTIME_ON
				...
				float temp_output_8_0_g11871 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g11871 = ( ( sin( ( temp_output_8_0_g11871 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g11871 );
				#else
				float2 staticSwitch4_g11871 = temp_output_2_0_g11871;
				#endif
				#ifdef _ENABLEVIBRATE_ON
				float temp_output_30_0_g11872 = temp_output_8_0_g11871;
				float3 rotatedValue21_g11872 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g11872 * _VibrateRotation ) );
				float2 staticSwitch6_g11871 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g11872 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g11872).xy ) + staticSwitch4_g11871 );
				#else
				float2 staticSwitch6_g11871 = staticSwitch4_g11871;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g11871 = ( staticSwitch6_g11871 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g11871 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
				float2 staticSwitch10_g11871 = staticSwitch6_g11871;
				#endif
				float2 temp_output_424_0 = staticSwitch10_g11871;
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11706 = tex2Dlod( _FadingMask, float4( uv_FadingMask, 0, 0.0) );
				...
				float staticSwitch139 = ( _FadingFade * ( tex2DNode3_g11706.r * tex2DNode3_g11706.a ) );
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float linValue16_g11712 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				...
				#ifdef _ENABLEGLITCH_ON
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11712 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				float2 staticSwitch62 = staticSwitch59;
				#endif
				float2 temp_output_1_0_g11713 = staticSwitch62;
				float2 temp_output_26_0_g11713 = shaderPosition235;
				float temp_output_25_0_g11713 = shaderTime237;
				float linValue16_g11723 = tex2D( _UberNoiseTexture, ( ( temp_output_26_0_g11713 + ( _UVDistortSpeed * temp_output_25_0_g11713 ) ) * _UVDistortNoiseScale ) ).r;
				float localMyCustomExpression16_g11723 = MyCustomExpression16_g11723( linValue16_g11723 );
				float2 lerpResult21_g11720 = lerp( _UVDistortFrom , _UVDistortTo , localMyCustomExpression16_g11723);
				float2 appendResult2_g11722 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				#ifdef _UVDISTORTMASKTOGGLE_ON
				float2 uv_UVDistortMask = IN.texcoord.xy * _UVDistortMask_ST.xy + _UVDistortMask_ST.zw;
				float4 tex2DNode3_g11721 = tex2D( _UVDistortMask, uv_UVDistortMask );
				float staticSwitch29_g11720 = ( _UVDistortFade * ( tex2DNode3_g11721.r * tex2DNode3_g11721.a ) );
				#else
				float staticSwitch29_g11720 = _UVDistortFade;
				#endif
				#ifdef _ENABLEUVDISTORT_ON
				float2 staticSwitch5_g11713 = ( temp_output_1_0_g11713 + ( lerpResult21_g11720 * ( 100.0 / appendResult2_g11722 ) * staticSwitch29_g11720 ) );
				#else
				float2 staticSwitch5_g11713 = temp_output_1_0_g11713;
				#endif
				#ifdef _ENABLESQUEEZE_ON
				float2 temp_output_1_0_g11719 = staticSwitch5_g11713;
				float2 staticSwitch7_g11713 = ( temp_output_1_0_g11719 + ( ( temp_output_1_0_g11719 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g11719 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g11713 = staticSwitch5_g11713;
				#endif
				#ifdef _ENABLESINEROTATE_ON
				float3 rotatedValue36_g11718 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g11713 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g11713 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				float2 staticSwitch9_g11713 = (rotatedValue36_g11718).xy;
				#else
				float2 staticSwitch9_g11713 = staticSwitch7_g11713;
				#endif
				#ifdef _ENABLEUVROTATE_ON
				float3 rotatedValue8_g11717 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g11713 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g11713 * _UVRotateSpeed * UNITY_PI ) );
				float2 staticSwitch16_g11713 = (rotatedValue8_g11717).xy;
				#else
				float2 staticSwitch16_g11713 = staticSwitch9_g11713;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g11713 = ( ( _UVScrollSpeed * temp_output_25_0_g11713 ) + staticSwitch16_g11713 );
				#else
				float2 staticSwitch14_g11713 = staticSwitch16_g11713;
				#endif
				#ifdef _ENABLEPIXELATE_ON
				float2 appendResult35_g11715 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g11715 = ( ( _PixelatePixelDensity * ( appendResult35_g11715 / _PixelatePixelsPerUnit ) ) * ( 1.0 / max( _PixelateFade , 1E-05 ) ) );
				float2 clampResult46_g11715 = clamp( ( floor( ( MultFactor30_g11715 * ( staticSwitch14_g11713 + ( float2( 0.5,0.5 ) / MultFactor30_g11715 ) ) ) ) / MultFactor30_g11715 ) , float2( 0,0 ) , float2( 1,1 ) );
				float2 staticSwitch4_g11713 = clampResult46_g11715;
				#else
				float2 staticSwitch4_g11713 = staticSwitch14_g11713;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g11713 = ( ( ( staticSwitch4_g11713 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g11713 = staticSwitch4_g11713;
				#endif
				float2 temp_output_1_0_g11724 = staticSwitch24_g11713;
				float temp_output_7_0_g11724 = ( sin( ( _WiggleFrequency * ( temp_output_26_0_g11713.y + ( _WiggleSpeed * temp_output_25_0_g11713 ) ) ) ) * _WiggleOffset * _WiggleFade );
				#ifdef _WIGGLEFIXEDGROUNDTOGGLE_ON
				float staticSwitch18_g11724 = ( temp_output_7_0_g11724 * temp_output_1_0_g11724.y );
				#else
				float staticSwitch18_g11724 = temp_output_7_0_g11724;
				#endif
				#ifdef _ENABLEWIGGLE_ON
				float2 appendResult12_g11724 = (float2(staticSwitch18_g11724 , 0.0));
				float2 staticSwitch13_g11724 = ( temp_output_1_0_g11724 + appendResult12_g11724 );
				#else
				float2 staticSwitch13_g11724 = temp_output_1_0_g11724;
				#endif
				float2 temp_output_484_0 = staticSwitch13_g11724;
				float2 texCoord131 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11706 = tex2D( _FadingMask, uv_FadingMask );
				float temp_output_4_0_g11707 = max( _FadingWidth , 0.001 );
				...
				#endif
				#ifdef _SPRITESHEETFIX_ON
				float2 break14_g11725 = staticSwitch485;
				float2 break11_g11725 = float2( 0,0 );
				float2 break10_g11725 = float2( 1,1 );
				float2 break9_g11725 = spriteRectMin376;
				float2 break8_g11725 = spriteRectMax377;
				float2 appendResult15_g11725 = (float2((break9_g11725.x + (break14_g11725.x - break11_g11725.x) * (break8_g11725.x - break9_g11725.x) / (break10_g11725.x - break11_g11725.x)) , (break9_g11725.y + (break14_g11725.y - break11_g11725.y) * (break8_g11725.y - break9_g11725.y) / (break10_g11725.y - break11_g11725.y))));
				float2 staticSwitch371 = min( max( appendResult15_g11725 , spriteRectMin376 ) , spriteRectMax377 );
				#else
				float2 staticSwitch371 = staticSwitch485;
				#endif
				#ifdef _PIXELPERFECTUV_ON
				float2 appendResult7_g11726 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g11726 ) ) / appendResult7_g11726 ) );
				#else
				float2 staticSwitch427 = staticSwitch371;
				#endif
				float2 finalUV146 = staticSwitch427;
				float2 temp_output_1_0_g11727 = finalUV146;
				#ifdef _ENABLESMOOTHPIXELART_ON
				sampler2D tex3_g11728 = _MainTex;
				float4 textureTexelSize3_g11728 = _MainTex_TexelSize;
				float2 uvs3_g11728 = temp_output_1_0_g11727;
				float4 localtexturePointSmooth3_g11728 = texturePointSmooth( tex3_g11728 , textureTexelSize3_g11728 , uvs3_g11728 );
				float4 staticSwitch8_g11727 = localtexturePointSmooth3_g11728;
				#else
				float4 staticSwitch8_g11727 = tex2D( _MainTex, temp_output_1_0_g11727 );
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float temp_output_10_0_g11729 = ( _GaussianBlurOffset * _GaussianBlurFade * 0.005 );
				float temp_output_2_0_g11739 = temp_output_10_0_g11729;
				...
				float2 temp_output_7_0_g11729 = temp_output_1_0_g11727;
				float2 temp_output_1_0_g11739 = ( temp_output_7_0_g11729 + ( temp_output_10_0_g11729 * float2( 1,1 ) ) );
				...
				float temp_output_2_0_g11730 = temp_output_10_0_g11729;
				float2 appendResult16_g11730 = (float2(temp_output_2_0_g11730 , 0.0));
				float2 appendResult25_g11732 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11732 = ( appendResult16_g11730 * appendResult25_g11732 );
				float2 temp_output_1_0_g11730 = ( temp_output_7_0_g11729 + ( temp_output_10_0_g11729 * float2( -1,1 ) ) );
				float2 temp_output_1_0_g11732 = temp_output_1_0_g11730;
				float2 appendResult17_g11730 = (float2(0.0 , temp_output_2_0_g11730));
				float2 appendResult25_g11731 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11731 = ( appendResult17_g11730 * appendResult25_g11731 );
				float2 temp_output_1_0_g11731 = temp_output_1_0_g11730;
				float temp_output_2_0_g11736 = temp_output_10_0_g11729;
				...
				float2 temp_output_1_0_g11736 = ( temp_output_7_0_g11729 + ( temp_output_10_0_g11729 * float2( -1,-1 ) ) );
				...
				float temp_output_2_0_g11733 = temp_output_10_0_g11729;
				...
				float2 temp_output_1_0_g11733 = ( temp_output_7_0_g11729 + ( temp_output_10_0_g11729 * float2( 1,-1 ) ) );
				...
				float4 staticSwitch3_g11727 = ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11740 + temp_output_1_0_g11740 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11740 + temp_output_1_0_g11740 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11732 + temp_output_1_0_g11732 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11732 + temp_output_1_0_g11732 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11731 + temp_output_1_0_g11731 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11731 + temp_output_1_0_g11731 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11737 + temp_output_1_0_g11737 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11737 + temp_output_1_0_g11737 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11735 + temp_output_1_0_g11735 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11735 + temp_output_1_0_g11735 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11734 + temp_output_1_0_g11734 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11734 + temp_output_1_0_g11734 ) ) ) ) ) * 0.0625 );
				#else
				float4 staticSwitch3_g11727 = staticSwitch8_g11727;
				#endif
				#ifdef _ENABLESHARPEN_ON
				float2 temp_output_1_0_g11742 = temp_output_1_0_g11727;
				float4 tex2DNode4_g11742 = tex2D( _MainTex, temp_output_1_0_g11742 );
				float temp_output_2_0_g11743 = _SharpenOffset;
				...
				float4 break22_g11742 = ( tex2DNode4_g11742 - ( ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) ) ) / 4.0 ) - tex2DNode4_g11742 ) * ( _SharpenFactor * _SharpenFade ) ) );
				float clampResult23_g11742 = clamp( break22_g11742.a , 0.0 , 1.0 );
				float4 appendResult24_g11742 = (float4(break22_g11742.r , break22_g11742.g , break22_g11742.b , clampResult23_g11742));
				float4 staticSwitch12_g11727 = appendResult24_g11742;
				#else
				float4 staticSwitch12_g11727 = staticSwitch3_g11727;
				#endif
				float4 temp_output_471_0 = staticSwitch12_g11727;
				#ifdef _VERTEXTINTFIRST_ON
				float4 temp_output_1_0_g11746 = temp_output_471_0;
				float4 appendResult8_g11746 = (float4(( (temp_output_1_0_g11746).rgb * (IN.color).rgb ) , temp_output_1_0_g11746.a));
				float4 staticSwitch354 = appendResult8_g11746;
				#else
				float4 staticSwitch354 = temp_output_471_0;
				#endif
				float4 originalColor191 = staticSwitch354;
				float4 temp_output_1_0_g11747 = originalColor191;
				float4 temp_output_1_0_g11748 = temp_output_1_0_g11747;
				float2 temp_output_7_0_g11747 = finalUV146;
				float2 temp_output_43_0_g11748 = temp_output_7_0_g11747;
				float2 temp_cast_15 = (_SmokeNoiseScale).xx;
				float linValue16_g11749 = tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g11748 ) * temp_cast_15 ) ).r;
				float localMyCustomExpression16_g11749 = MyCustomExpression16_g11749( linValue16_g11749 );
				float clampResult28_g11748 = clamp( ( ( ( localMyCustomExpression16_g11749 - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g11748 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				#ifdef _ENABLESMOKE_ON
				float3 lerpResult34_g11748 = lerp( (temp_output_1_0_g11748).rgb , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g11748 ) * _SmokeDarkEdge ));
				float4 appendResult31_g11748 = (float4(lerpResult34_g11748 , ( clampResult28_g11748 * _SmokeAlpha * temp_output_1_0_g11748.a )));
				float4 staticSwitch2_g11747 = appendResult31_g11748;
				#else
				float4 staticSwitch2_g11747 = temp_output_1_0_g11747;
				#endif
				#ifdef _ENABLECUSTOMFADE_ON
				float4 temp_output_1_0_g11750 = staticSwitch2_g11747;
				float2 temp_output_57_0_g11750 = temp_output_7_0_g11747;
				float4 tex2DNode3_g11750 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g11750 );
				float linValue16_g11751 = tex2D( _UberNoiseTexture, ( temp_output_57_0_g11750 * _CustomFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11751 = MyCustomExpression16_g11751( linValue16_g11751 );
				float clampResult37_g11750 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g11750.r + ( localMyCustomExpression16_g11751 * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g11750 = (float4((temp_output_1_0_g11750).rgb , ( temp_output_1_0_g11750.a * pow( clampResult37_g11750 , ( _CustomFadeSmoothness / max( tex2DNode3_g11750.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				float4 staticSwitch3_g11747 = appendResult13_g11750;
				#else
				float4 staticSwitch3_g11747 = staticSwitch2_g11747;
				#endif
				float4 temp_output_1_0_g11752 = staticSwitch3_g11747;
				#ifdef _ENABLECHECKERBOARD_ON
				float4 temp_output_1_0_g11753 = temp_output_1_0_g11752;
				float2 appendResult4_g11753 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 temp_output_44_0_g11753 = ( appendResult4_g11753 * _CheckerboardTiling * 0.5 );
				float2 break12_g11753 = step( ( ceil( temp_output_44_0_g11753 ) - temp_output_44_0_g11753 ) , float2( 0.5,0.5 ) );
				float4 appendResult42_g11753 = (float4(( (temp_output_1_0_g11753).rgb * min( ( _CheckerboardDarken + abs( ( -break12_g11753.x + break12_g11753.y ) ) ) , 1.0 ) ) , temp_output_1_0_g11753.a));
				float4 staticSwitch2_g11752 = appendResult42_g11753;
				#else
				float4 staticSwitch2_g11752 = temp_output_1_0_g11752;
				#endif
				float2 temp_output_75_0_g11754 = finalUV146;
				float linValue16_g11755 = tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g11754 ) * _FlameNoiseScale ) ).r;
				float localMyCustomExpression16_g11755 = MyCustomExpression16_g11755( linValue16_g11755 );
				float saferPower57_g11754 = abs( max( ( temp_output_75_0_g11754.y - 0.2 ) , 0.0 ) );
				float temp_output_47_0_g11754 = max( _FlameRadius , 0.01 );
				float clampResult70_g11754 = clamp( ( ( ( localMyCustomExpression16_g11755 * pow( saferPower57_g11754 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g11754 - distance( temp_output_75_0_g11754 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g11754 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				#ifdef _ENABLEFLAME_ON
				float temp_output_63_0_g11754 = ( clampResult70_g11754 * _FlameBrightness );
				float4 appendResult31_g11754 = (float4(temp_output_63_0_g11754 , temp_output_63_0_g11754 , temp_output_63_0_g11754 , clampResult70_g11754));
				float4 staticSwitch6_g11752 = ( appendResult31_g11754 * staticSwitch2_g11752 );
				#else
				float4 staticSwitch6_g11752 = staticSwitch2_g11752;
				#endif
				float4 temp_output_3_0_g11756 = staticSwitch6_g11752;
				float4 temp_output_1_0_g11783 = temp_output_3_0_g11756;
				float2 temp_output_1_0_g11756 = finalUV146;
				#ifdef _RECOLORRGBTEXTURETOGGLE_ON
				float4 staticSwitch81_g11783 = tex2D( _RecolorRGBTexture, temp_output_1_0_g11756 );
				#else
				float4 staticSwitch81_g11783 = temp_output_1_0_g11783;
				#endif
				#ifdef _ENABLERECOLORRGB_ON
				float4 break82_g11783 = staticSwitch81_g11783;
				float temp_output_63_0_g11783 = ( break82_g11783.r + break82_g11783.g + break82_g11783.b );
				float4 break71_g11783 = ( ( _RecolorRGBRedTint * ( break82_g11783.r / temp_output_63_0_g11783 ) ) + ( _RecolorRGBGreenTint * ( break82_g11783.g / temp_output_63_0_g11783 ) ) + ( ( break82_g11783.b / temp_output_63_0_g11783 ) * _RecolorRGBBlueTint ) );
				float3 appendResult56_g11783 = (float3(break71_g11783.r , break71_g11783.g , break71_g11783.b));
				...
				float3 lerpResult26_g11783 = lerp( (temp_output_1_0_g11783).rgb , ( appendResult56_g11783 * pow( saferPower57_g11783 , ( max( break71_g11783.a , 0.01 ) * 2.0 ) ) ) , ( min( ( temp_output_63_0_g11783 * 2.0 ) , 1.0 ) * _RecolorRGBFade ));
				float4 appendResult30_g11783 = (float4(lerpResult26_g11783 , temp_output_1_0_g11783.a));
				float4 staticSwitch43_g11756 = appendResult30_g11783;
				#else
				float4 staticSwitch43_g11756 = temp_output_3_0_g11756;
				#endif
				float4 temp_output_1_0_g11781 = staticSwitch43_g11756;
				#ifdef _RECOLORRGBYCPTEXTURETOGGLE_ON
				float4 staticSwitch62_g11781 = tex2D( _RecolorRGBYCPTexture, temp_output_1_0_g11756 );
				#else
				float4 staticSwitch62_g11781 = temp_output_1_0_g11781;
				#endif
				float3 hsvTorgb33_g11781 = RGBToHSV( staticSwitch62_g11781.rgb );
				float temp_output_43_0_g11781 = ( ( hsvTorgb33_g11781.x + 0.08333334 ) % 1.0 );
				float4 ifLocalVar46_g11781 = 0;
				if( temp_output_43_0_g11781 >= 0.8333333 )
				ifLocalVar46_g11781 = _RecolorRGBYCPPurpleTint;
				else
				ifLocalVar46_g11781 = _RecolorRGBYCPBlueTint;
				float4 ifLocalVar44_g11781 = 0;
				if( temp_output_43_0_g11781 <= 0.6666667 )
				ifLocalVar44_g11781 = _RecolorRGBYCPCyanTint;
				else
				ifLocalVar44_g11781 = ifLocalVar46_g11781;
				float4 ifLocalVar47_g11781 = 0;
				if( temp_output_43_0_g11781 <= 0.3333333 )
				ifLocalVar47_g11781 = _RecolorRGBYCPYellowTint;
				else
				ifLocalVar47_g11781 = _RecolorRGBYCPGreenTint;
				float4 ifLocalVar45_g11781 = 0;
				if( temp_output_43_0_g11781 <= 0.1666667 )
				ifLocalVar45_g11781 = _RecolorRGBYCPRedTint;
				else
				ifLocalVar45_g11781 = ifLocalVar47_g11781;
				float4 ifLocalVar35_g11781 = 0;
				if( temp_output_43_0_g11781 >= 0.5 )
				ifLocalVar35_g11781 = ifLocalVar44_g11781;
				else
				ifLocalVar35_g11781 = ifLocalVar45_g11781;
				#ifdef _ENABLERECOLORRGBYCP_ON
				float4 break55_g11781 = ifLocalVar35_g11781;
				float3 appendResult56_g11781 = (float3(break55_g11781.r , break55_g11781.g , break55_g11781.b));
				float4 break2_g11782 = temp_output_1_0_g11781;
				float saferPower57_g11781 = abs( ( ( break2_g11782.x + break2_g11782.x + break2_g11782.y + break2_g11782.y + break2_g11782.y + break2_g11782.z ) / 6.0 ) );
				float3 lerpResult26_g11781 = lerp( (temp_output_1_0_g11781).rgb , ( appendResult56_g11781 * pow( saferPower57_g11781 , max( ( break55_g11781.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g11781.z * _RecolorRGBYCPFade ));
				float4 appendResult30_g11781 = (float4(lerpResult26_g11781 , temp_output_1_0_g11781.a));
				float4 staticSwitch9_g11756 = appendResult30_g11781;
				#else
				float4 staticSwitch9_g11756 = staticSwitch43_g11756;
				#endif
				#ifdef _ENABLECOLORREPLACE_ON
				float4 temp_output_1_0_g11759 = staticSwitch9_g11756;
				float3 temp_output_2_0_g11759 = (temp_output_1_0_g11759).rgb;
				float3 In115_g11759 = temp_output_2_0_g11759;
				float3 From115_g11759 = (_ColorReplaceFromColor).rgb;
				float4 break2_g11760 = temp_output_1_0_g11759;
				float3 To115_g11759 = ( pow( ( ( break2_g11760.x + break2_g11760.x + break2_g11760.y + break2_g11760.y + break2_g11760.y + break2_g11760.z ) / 6.0 ) , max( _ColorReplaceContrast , 0.0001 ) ) * (_ColorReplaceToColor).rgb );
				float Fuzziness115_g11759 = _ColorReplaceSmoothness;
				float Range115_g11759 = _ColorReplaceRange;
				float3 localMyCustomExpression115_g11759 = MyCustomExpression115_g11759( In115_g11759 , From115_g11759 , To115_g11759 , Fuzziness115_g11759 , Range115_g11759 );
				float3 lerpResult112_g11759 = lerp( temp_output_2_0_g11759 , localMyCustomExpression115_g11759 , _ColorReplaceFade);
				float4 appendResult4_g11759 = (float4(lerpResult112_g11759 , temp_output_1_0_g11759.a));
				float4 staticSwitch29_g11756 = appendResult4_g11759;
				#else
				float4 staticSwitch29_g11756 = staticSwitch9_g11756;
				#endif
				float4 temp_output_1_0_g11770 = staticSwitch29_g11756;
				#ifdef _ENABLENEGATIVE_ON
				float3 temp_output_9_0_g11770 = (temp_output_1_0_g11770).rgb;
				float3 lerpResult3_g11770 = lerp( temp_output_9_0_g11770 , ( 1.0 - temp_output_9_0_g11770 ) , _NegativeFade);
				float4 appendResult8_g11770 = (float4(lerpResult3_g11770 , temp_output_1_0_g11770.a));
				float4 staticSwitch4_g11770 = appendResult8_g11770;
				#else
				float4 staticSwitch4_g11770 = temp_output_1_0_g11770;
				#endif
				float4 temp_output_57_0_g11756 = staticSwitch4_g11770;
				#ifdef _ENABLECONTRAST_ON
				float4 temp_output_1_0_g11791 = temp_output_57_0_g11756;
				float3 saferPower5_g11791 = abs( (temp_output_1_0_g11791).rgb );
				float3 temp_cast_29 = (_Contrast).xxx;
				float4 appendResult4_g11791 = (float4(pow( saferPower5_g11791 , temp_cast_29 ) , temp_output_1_0_g11791.a));
				float4 staticSwitch32_g11756 = appendResult4_g11791;
				#else
				float4 staticSwitch32_g11756 = temp_output_57_0_g11756;
				#endif
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 temp_output_2_0_g11768 = staticSwitch32_g11756;
				float4 appendResult6_g11768 = (float4(( (temp_output_2_0_g11768).rgb * _Brightness ) , temp_output_2_0_g11768.a));
				float4 staticSwitch33_g11756 = appendResult6_g11768;
				#else
				float4 staticSwitch33_g11756 = staticSwitch32_g11756;
				#endif
				#ifdef _ENABLEHUE_ON
				float4 temp_output_2_0_g11769 = staticSwitch33_g11756;
				float3 hsvTorgb1_g11769 = RGBToHSV( temp_output_2_0_g11769.rgb );
				float3 hsvTorgb3_g11769 = HSVToRGB( float3(( hsvTorgb1_g11769.x + _Hue ),hsvTorgb1_g11769.y,hsvTorgb1_g11769.z) );
				float4 appendResult8_g11769 = (float4(hsvTorgb3_g11769 , temp_output_2_0_g11769.a));
				float4 staticSwitch36_g11756 = appendResult8_g11769;
				#else
				float4 staticSwitch36_g11756 = staticSwitch33_g11756;
				#endif
				#ifdef _ENABLESPLITTONING_ON
				float4 temp_output_1_0_g11785 = staticSwitch36_g11756;
				float4 break2_g11786 = temp_output_1_0_g11785;
				float temp_output_3_0_g11785 = ( ( break2_g11786.x + break2_g11786.x + break2_g11786.y + break2_g11786.y + break2_g11786.y + break2_g11786.z ) / 6.0 );
				float clampResult25_g11785 = clamp( ( ( ( ( temp_output_3_0_g11785 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g11785 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g11785);
				float temp_output_9_0_g11787 = max( _SplitToningContrast , 0.0 );
				float saferPower7_g11787 = abs( ( temp_output_3_0_g11785 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11787 ) , 0.0 ) ) ) );
				float3 lerpResult11_g11785 = lerp( (temp_output_1_0_g11785).rgb , ( lerpResult6_g11785 * pow( saferPower7_g11787 , temp_output_9_0_g11787 ) ) , _SplitToningFade);
				float4 appendResult18_g11785 = (float4(lerpResult11_g11785 , temp_output_1_0_g11785.a));
				float4 staticSwitch30_g11756 = appendResult18_g11785;
				#else
				float4 staticSwitch30_g11756 = staticSwitch36_g11756;
				#endif
				#ifdef _ENABLEBLACKTINT_ON
				float4 temp_output_1_0_g11766 = staticSwitch30_g11756;
				float3 temp_output_4_0_g11766 = (temp_output_1_0_g11766).rgb;
				float4 break12_g11766 = temp_output_1_0_g11766;
				float3 lerpResult7_g11766 = lerp( temp_output_4_0_g11766 , ( temp_output_4_0_g11766 + (_BlackTintColor).rgb ) , pow( ( 1.0 - min( max( max( break12_g11766.r , break12_g11766.g ) , break12_g11766.b ) , 1.0 ) ) , max( _BlackTintPower , 0.001 ) ));
				float3 lerpResult13_g11766 = lerp( temp_output_4_0_g11766 , lerpResult7_g11766 , _BlackTintFade);
				float4 appendResult11_g11766 = (float4(lerpResult13_g11766 , break12_g11766.a));
				float4 staticSwitch20_g11756 = appendResult11_g11766;
				#else
				float4 staticSwitch20_g11756 = staticSwitch30_g11756;
				#endif
				#ifdef _ENABLEINKSPREAD_ON
				float4 temp_output_1_0_g11777 = staticSwitch20_g11756;
				float4 break2_g11779 = temp_output_1_0_g11777;
				float temp_output_9_0_g11780 = max( _InkSpreadContrast , 0.0 );
				float saferPower7_g11780 = abs( ( ( ( break2_g11779.x + break2_g11779.x + break2_g11779.y + break2_g11779.y + break2_g11779.y + break2_g11779.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11780 ) , 0.0 ) ) ) );
				float2 temp_output_65_0_g11777 = shaderPosition235;
				float linValue16_g11778 = tex2D( _UberNoiseTexture, ( temp_output_65_0_g11777 * _InkSpreadNoiseScale ) ).r;
				float localMyCustomExpression16_g11778 = MyCustomExpression16_g11778( linValue16_g11778 );
				float clampResult53_g11777 = clamp( ( ( ( _InkSpreadDistance - distance( _InkSpreadPosition , temp_output_65_0_g11777 ) ) + ( localMyCustomExpression16_g11778 * _InkSpreadNoiseFactor ) ) / max( _InkSpreadWidth , 0.001 ) ) , 0.0 , 1.0 );
				float3 lerpResult7_g11777 = lerp( (temp_output_1_0_g11777).rgb , ( (_InkSpreadColor).rgb * pow( saferPower7_g11780 , temp_output_9_0_g11780 ) ) , ( _InkSpreadFade * clampResult53_g11777 ));
				float4 appendResult9_g11777 = (float4(lerpResult7_g11777 , (temp_output_1_0_g11777).a));
				float4 staticSwitch17_g11756 = appendResult9_g11777;
				#else
				float4 staticSwitch17_g11756 = staticSwitch20_g11756;
				#endif
				float temp_output_39_0_g11756 = shaderTime237;
				#ifdef _ENABLESHIFTHUE_ON
				float4 temp_output_1_0_g11771 = staticSwitch17_g11756;
				float3 hsvTorgb15_g11771 = RGBToHSV( (temp_output_1_0_g11771).rgb );
				float3 hsvTorgb19_g11771 = HSVToRGB( float3(( ( temp_output_39_0_g11756 * _ShiftHueSpeed ) + hsvTorgb15_g11771.x ),hsvTorgb15_g11771.y,hsvTorgb15_g11771.z) );
				float4 appendResult6_g11771 = (float4(hsvTorgb19_g11771 , temp_output_1_0_g11771.a));
				float4 staticSwitch19_g11756 = appendResult6_g11771;
				#else
				float4 staticSwitch19_g11756 = staticSwitch17_g11756;
				#endif
				float3 hsvTorgb19_g11774 = HSVToRGB( float3(( ( temp_output_39_0_g11756 * _AddHueSpeed ) % 1.0 ),_AddHueSaturation,_AddHueBrightness) );
				float4 temp_output_1_0_g11774 = staticSwitch19_g11756;
				float4 break2_g11776 = temp_output_1_0_g11774;
				float saferPower27_g11774 = abs( ( ( break2_g11776.x + break2_g11776.x + break2_g11776.y + break2_g11776.y + break2_g11776.y + break2_g11776.z ) / 6.0 ) );
				#ifdef _ADDHUEMASKTOGGLE_ON
				float2 uv_AddHueMask = IN.texcoord.xy * _AddHueMask_ST.xy + _AddHueMask_ST.zw;
				float4 tex2DNode3_g11775 = tex2D( _AddHueMask, uv_AddHueMask );
				float staticSwitch33_g11774 = ( _AddHueFade * ( tex2DNode3_g11775.r * tex2DNode3_g11775.a ) );
				#else
				float staticSwitch33_g11774 = _AddHueFade;
				#endif
				#ifdef _ENABLEADDHUE_ON
				float4 appendResult6_g11774 = (float4(( ( hsvTorgb19_g11774 * pow( saferPower27_g11774 , max( _AddHueContrast , 0.001 ) ) * staticSwitch33_g11774 ) + (temp_output_1_0_g11774).rgb ) , temp_output_1_0_g11774.a));
				float4 staticSwitch23_g11756 = appendResult6_g11774;
				#else
				float4 staticSwitch23_g11756 = staticSwitch19_g11756;
				#endif
				float4 temp_output_1_0_g11772 = staticSwitch23_g11756;
				float4 break2_g11773 = temp_output_1_0_g11772;
				float3 temp_output_13_0_g11772 = (_SineGlowColor).rgb;
				#ifdef _SINEGLOWMASKTOGGLE_ON
				float2 uv_SineGlowMask = IN.texcoord.xy * _SineGlowMask_ST.xy + _SineGlowMask_ST.zw;
				float4 tex2DNode30_g11772 = tex2D( _SineGlowMask, uv_SineGlowMask );
				float3 staticSwitch27_g11772 = ( (tex2DNode30_g11772).rgb * temp_output_13_0_g11772 * tex2DNode30_g11772.a );
				#else
				float3 staticSwitch27_g11772 = temp_output_13_0_g11772;
				#endif
				#ifdef _ENABLESINEGLOW_ON
				float4 appendResult21_g11772 = (float4(( (temp_output_1_0_g11772).rgb + ( pow( ( ( break2_g11773.x + break2_g11773.x + break2_g11773.y + break2_g11773.y + break2_g11773.y + break2_g11773.z ) / 6.0 ) , max( _SineGlowContrast , 0.0 ) ) * staticSwitch27_g11772 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g11756 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g11772.a));
				float4 staticSwitch28_g11756 = appendResult21_g11772;
				#else
				float4 staticSwitch28_g11756 = staticSwitch23_g11756;
				#endif
				#ifdef _ENABLESATURATION_ON
				float4 temp_output_1_0_g11761 = staticSwitch28_g11756;
				float4 break2_g11762 = temp_output_1_0_g11761;
				float3 temp_cast_45 = (( ( break2_g11762.x + break2_g11762.x + break2_g11762.y + break2_g11762.y + break2_g11762.y + break2_g11762.z ) / 6.0 )).xxx;
				float3 lerpResult5_g11761 = lerp( temp_cast_45 , (temp_output_1_0_g11761).rgb , _Saturation);
				float4 appendResult8_g11761 = (float4(lerpResult5_g11761 , temp_output_1_0_g11761.a));
				float4 staticSwitch38_g11756 = appendResult8_g11761;
				#else
				float4 staticSwitch38_g11756 = staticSwitch28_g11756;
				#endif
				float4 temp_output_15_0_g11763 = staticSwitch38_g11756;
				float3 temp_output_82_0_g11763 = (_InnerOutlineColor).rgb;
				float2 temp_output_7_0_g11763 = temp_output_1_0_g11756;
				float temp_output_179_0_g11763 = temp_output_39_0_g11756;
				#ifdef _INNEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch187_g11763 = ( (tex2D( _InnerOutlineTintTexture, ( temp_output_7_0_g11763 + ( _InnerOutlineTextureSpeed * temp_output_179_0_g11763 ) ) )).rgb * temp_output_82_0_g11763 );
				#else
				float3 staticSwitch187_g11763 = temp_output_82_0_g11763;
				#endif
				#ifdef _INNEROUTLINEDISTORTIONTOGGLE_ON
				float linValue16_g11765 = tex2D( _UberNoiseTexture, ( ( ( temp_output_179_0_g11763 * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g11763 ) * _InnerOutlineNoiseScale ) ).r;
				float localMyCustomExpression16_g11765 = MyCustomExpression16_g11765( linValue16_g11765 );
				float2 staticSwitch169_g11763 = ( ( localMyCustomExpression16_g11765 - 0.5 ) * _InnerOutlineDistortionIntensity );
				#else
				float2 staticSwitch169_g11763 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11763 = ( staticSwitch169_g11763 + temp_output_7_0_g11763 );
				float2 appendResult2_g11764 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g11763 = ( 100.0 / appendResult2_g11764 );
				float temp_output_178_0_g11763 = ( _InnerOutlineFade * ( 1.0 - min( min( min( min( min( min( min( tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11763 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11763 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11763 + ( ( _InnerOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11763 ) ) ).a ) ) );
				float3 lerpResult176_g11763 = lerp( (temp_output_15_0_g11763).rgb , staticSwitch187_g11763 , temp_output_178_0_g11763);
				#ifdef _INNEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch188_g11763 = ( temp_output_178_0_g11763 * temp_output_15_0_g11763.a );
				#else
				float staticSwitch188_g11763 = temp_output_15_0_g11763.a;
				#endif
				#ifdef _ENABLEINNEROUTLINE_ON
				float4 appendResult177_g11763 = (float4(lerpResult176_g11763 , staticSwitch188_g11763));
				float4 staticSwitch12_g11756 = appendResult177_g11763;
				#else
				float4 staticSwitch12_g11756 = staticSwitch38_g11756;
				#endif
				float4 temp_output_15_0_g11788 = staticSwitch12_g11756;
				float3 temp_output_82_0_g11788 = (_OuterOutlineColor).rgb;
				float2 temp_output_7_0_g11788 = temp_output_1_0_g11756;
				float temp_output_186_0_g11788 = temp_output_39_0_g11756;
				#ifdef _OUTEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11788 = ( (tex2D( _OuterOutlineTintTexture, ( temp_output_7_0_g11788 + ( _OuterOutlineTextureSpeed * temp_output_186_0_g11788 ) ) )).rgb * temp_output_82_0_g11788 );
				#else
				float3 staticSwitch199_g11788 = temp_output_82_0_g11788;
				#endif
				float temp_output_182_0_g11788 = ( ( 1.0 - temp_output_15_0_g11788.a ) * min( ( _OuterOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11788 = 1.0;
				#else
				float staticSwitch203_g11788 = temp_output_182_0_g11788;
				#endif
				float3 lerpResult178_g11788 = lerp( (temp_output_15_0_g11788).rgb , staticSwitch199_g11788 , staticSwitch203_g11788);
				float3 lerpResult170_g11788 = lerp( lerpResult178_g11788 , staticSwitch199_g11788 , staticSwitch203_g11788);
				#ifdef _OUTEROUTLINEDISTORTIONTOGGLE_ON
				float linValue16_g11789 = tex2D( _UberNoiseTexture, ( ( ( temp_output_186_0_g11788 * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g11788 ) * _OuterOutlineNoiseScale ) ).r;
				float localMyCustomExpression16_g11789 = MyCustomExpression16_g11789( linValue16_g11789 );
				float2 staticSwitch157_g11788 = ( ( localMyCustomExpression16_g11789 - 0.5 ) * _OuterOutlineDistortionIntensity );
				#else
				float2 staticSwitch157_g11788 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11788 = ( staticSwitch157_g11788 + temp_output_7_0_g11788 );
				float2 appendResult2_g11790 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g11788 = ( 100.0 / appendResult2_g11790 );
				float lerpResult168_g11788 = lerp( temp_output_15_0_g11788.a , min( ( max( max( max( max( max( max( max( tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11788 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11788 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11788 + ( ( _OuterOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11788 ) ) ).a ) * 3.0 ) , 1.0 ) , _OuterOutlineFade);
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11788 = ( temp_output_182_0_g11788 * lerpResult168_g11788 );
				#else
				float staticSwitch200_g11788 = lerpResult168_g11788;
				#endif
				#ifdef _ENABLEOUTEROUTLINE_ON
				float4 appendResult174_g11788 = (float4(lerpResult170_g11788 , staticSwitch200_g11788));
				float4 staticSwitch13_g11756 = appendResult174_g11788;
				#else
				float4 staticSwitch13_g11756 = staticSwitch12_g11756;
				#endif
				float4 temp_output_15_0_g11767 = staticSwitch13_g11756;
				float3 temp_output_82_0_g11767 = (_PixelOutlineColor).rgb;
				float2 temp_output_7_0_g11767 = temp_output_1_0_g11756;
				#ifdef _PIXELOUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11767 = ( (tex2D( _PixelOutlineTintTexture, ( temp_output_7_0_g11767 + ( _PixelOutlineTextureSpeed * temp_output_39_0_g11756 ) ) )).rgb * temp_output_82_0_g11767 );
				#else
				float3 staticSwitch199_g11767 = temp_output_82_0_g11767;
				#endif
				float temp_output_182_0_g11767 = ( ( 1.0 - temp_output_15_0_g11767.a ) * min( ( _PixelOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11767 = 1.0;
				#else
				float staticSwitch203_g11767 = temp_output_182_0_g11767;
				#endif
				float3 lerpResult178_g11767 = lerp( (temp_output_15_0_g11767).rgb , staticSwitch199_g11767 , staticSwitch203_g11767);
				float3 lerpResult170_g11767 = lerp( lerpResult178_g11767 , staticSwitch199_g11767 , staticSwitch203_g11767);
				float2 appendResult206_g11767 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_209_0_g11767 = ( float2( 1,1 ) / appendResult206_g11767 );
				float lerpResult168_g11767 = lerp( temp_output_15_0_g11767.a , min( ( max( max( max( tex2D( _MainTex, ( temp_output_7_0_g11767 + ( ( _PixelOutlineWidth * float2( 0,-1 ) ) * temp_output_209_0_g11767 ) ) ).a , tex2D( _MainTex, ( temp_output_7_0_g11767 + ( ( _PixelOutlineWidth * float2( 0,1 ) ) * temp_output_209_0_g11767 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11767 + ( ( _PixelOutlineWidth * float2( -1,0 ) ) * temp_output_209_0_g11767 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11767 + ( ( _PixelOutlineWidth * float2( 1,0 ) ) * temp_output_209_0_g11767 ) ) ).a ) * 3.0 ) , 1.0 ) , _PixelOutlineFade);
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11767 = ( temp_output_182_0_g11767 * lerpResult168_g11767 );
				#else
				float staticSwitch200_g11767 = lerpResult168_g11767;
				#endif
				#ifdef _ENABLEPIXELOUTLINE_ON
				float4 appendResult174_g11767 = (float4(lerpResult170_g11767 , staticSwitch200_g11767));
				float4 staticSwitch48_g11756 = appendResult174_g11767;
				#else
				float4 staticSwitch48_g11756 = staticSwitch13_g11756;
				#endif
				#ifdef _ENABLEPINGPONGGLOW_ON
				float3 lerpResult15_g11757 = lerp( (_PingPongGlowFrom).rgb , (_PingPongGlowTo).rgb , ( ( sin( ( temp_output_39_0_g11756 * _PingPongGlowFrequency ) ) + 1.0 ) / 2.0 ));
				float4 temp_output_5_0_g11757 = staticSwitch48_g11756;
				float4 break2_g11758 = temp_output_5_0_g11757;
				float4 appendResult12_g11757 = (float4(( ( lerpResult15_g11757 * _PingPongGlowFade * pow( ( ( break2_g11758.x + break2_g11758.x + break2_g11758.y + break2_g11758.y + break2_g11758.y + break2_g11758.z ) / 6.0 ) , max( _PingPongGlowContrast , 0.0 ) ) ) + (temp_output_5_0_g11757).rgb ) , temp_output_5_0_g11757.a));
				float4 staticSwitch46_g11756 = appendResult12_g11757;
				#else
				float4 staticSwitch46_g11756 = staticSwitch48_g11756;
				#endif
				float4 temp_output_361_0 = staticSwitch46_g11756;
				#ifdef _ENABLEHOLOGRAM_ON
				float4 temp_output_1_0_g11792 = temp_output_361_0;
				float4 break2_g11793 = temp_output_1_0_g11792;
				float temp_output_9_0_g11794 = max( _HologramContrast , 0.0 );
				float saferPower7_g11794 = abs( ( ( ( break2_g11793.x + break2_g11793.x + break2_g11793.y + break2_g11793.y + break2_g11793.y + break2_g11793.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11794 ) , 0.0 ) ) ) );
				float4 appendResult22_g11792 = (float4(( (_HologramTint).rgb * pow( saferPower7_g11794 , temp_output_9_0_g11794 ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g11792.a )));
				float4 lerpResult37_g11792 = lerp( temp_output_1_0_g11792 , appendResult22_g11792 , hologramFade182);
				float4 staticSwitch56 = lerpResult37_g11792;
				#else
				float4 staticSwitch56 = temp_output_361_0;
				#endif
				#ifdef _ENABLEGLITCH_ON
				float4 temp_output_1_0_g11795 = staticSwitch56;
				float4 break2_g11797 = temp_output_1_0_g11795;
				float temp_output_34_0_g11795 = shaderTime237;
				float linValue16_g11796 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchNoiseSpeed * temp_output_34_0_g11795 ) ) * _GlitchNoiseScale ) ).r;
				float localMyCustomExpression16_g11796 = MyCustomExpression16_g11796( linValue16_g11796 );
				float3 hsvTorgb3_g11798 = HSVToRGB( float3(( localMyCustomExpression16_g11796 + ( temp_output_34_0_g11795 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g11795 = lerp( (temp_output_1_0_g11795).rgb , ( ( ( break2_g11797.x + break2_g11797.x + break2_g11797.y + break2_g11797.y + break2_g11797.y + break2_g11797.z ) / 6.0 ) * _GlitchBrightness * hsvTorgb3_g11798 ) , glitchFade152);
				float4 appendResult27_g11795 = (float4(lerpResult23_g11795 , temp_output_1_0_g11795.a));
				float4 staticSwitch57 = appendResult27_g11795;
				#else
				float4 staticSwitch57 = staticSwitch56;
				#endif
				float4 temp_output_3_0_g11799 = staticSwitch57;
				float4 temp_output_1_0_g11824 = temp_output_3_0_g11799;
				float2 temp_output_41_0_g11799 = shaderPosition235;
				float2 temp_output_99_0_g11824 = temp_output_41_0_g11799;
				float temp_output_40_0_g11799 = shaderTime237;
				#ifdef _CAMOUFLAGEANIMATIONTOGGLE_ON
				float linValue16_g11829 = tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g11799 * _CamouflageDistortionSpeed ) + temp_output_99_0_g11824 ) * _CamouflageDistortionScale ) ).r;
				float localMyCustomExpression16_g11829 = MyCustomExpression16_g11829( linValue16_g11829 );
				float2 staticSwitch101_g11824 = ( ( ( localMyCustomExpression16_g11829 - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g11824 );
				#else
				float2 staticSwitch101_g11824 = temp_output_99_0_g11824;
				#endif
				float linValue16_g11826 = tex2D( _UberNoiseTexture, ( staticSwitch101_g11824 * _CamouflageNoiseScaleA ) ).r;
				float localMyCustomExpression16_g11826 = MyCustomExpression16_g11826( linValue16_g11826 );
				float clampResult52_g11824 = clamp( ( ( _CamouflageDensityA - localMyCustomExpression16_g11826 ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g11824 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g11824 ) , clampResult52_g11824);
				float linValue16_g11828 = tex2D( _UberNoiseTexture, ( ( staticSwitch101_g11824 + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r;
				#ifdef _ENABLECAMOUFLAGE_ON
				float localMyCustomExpression16_g11828 = MyCustomExpression16_g11828( linValue16_g11828 );
				float clampResult65_g11824 = clamp( ( ( _CamouflageDensityB - localMyCustomExpression16_g11828 ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g11824 = lerp( lerpResult55_g11824 , ( _CamouflageColorB * clampResult65_g11824 ) , clampResult65_g11824);
				float4 break2_g11827 = temp_output_1_0_g11824;
				float temp_output_9_0_g11825 = max( _CamouflageContrast , 0.0 );
				float saferPower7_g11825 = abs( ( ( ( break2_g11827.x + break2_g11827.x + break2_g11827.y + break2_g11827.y + break2_g11827.y + break2_g11827.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11825 ) , 0.0 ) ) ) );
				float3 lerpResult4_g11824 = lerp( (temp_output_1_0_g11824).rgb , ( (lerpResult68_g11824).rgb * pow( saferPower7_g11825 , temp_output_9_0_g11825 ) ) , _CamouflageFade);
				float4 appendResult7_g11824 = (float4(lerpResult4_g11824 , temp_output_1_0_g11824.a));
				float4 staticSwitch26_g11799 = appendResult7_g11824;
				#else
				float4 staticSwitch26_g11799 = temp_output_3_0_g11799;
				#endif
				float4 temp_output_1_0_g11818 = staticSwitch26_g11799;
				float temp_output_59_0_g11818 = temp_output_40_0_g11799;
				float2 temp_output_58_0_g11818 = temp_output_41_0_g11799;
				float linValue16_g11819 = tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g11818 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g11818 ) * _MetalNoiseDistortionScale ) ).r;
				float localMyCustomExpression16_g11819 = MyCustomExpression16_g11819( linValue16_g11819 );
				float linValue16_g11821 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11819 - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g11818 * _MetalNoiseSpeed ) + temp_output_58_0_g11818 ) ) * _MetalNoiseScale ) ).r;
				...
				float temp_output_5_0_g11818 = ( ( break2_g11820.x + break2_g11820.x + break2_g11820.y + break2_g11820.y + break2_g11820.y + break2_g11820.z ) / 6.0 );
				float temp_output_9_0_g11822 = max( _MetalHighlightContrast , 0.0 );
				float saferPower7_g11822 = abs( ( temp_output_5_0_g11818 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11822 ) , 0.0 ) ) ) );
				float saferPower2_g11818 = abs( temp_output_5_0_g11818 );
				#ifdef _METALMASKTOGGLE_ON
				float2 uv_MetalMask = IN.texcoord.xy * _MetalMask_ST.xy + _MetalMask_ST.zw;
				float4 tex2DNode3_g11823 = tex2D( _MetalMask, uv_MetalMask );
				float staticSwitch60_g11818 = ( _MetalFade * ( tex2DNode3_g11823.r * tex2DNode3_g11823.a ) );
				#else
				float staticSwitch60_g11818 = _MetalFade;
				#endif
				#ifdef _ENABLEMETAL_ON
				float4 lerpResult45_g11818 = lerp( temp_output_1_0_g11818 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g11821 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( saferPower7_g11822 , temp_output_9_0_g11822 ) ) + ( pow( saferPower2_g11818 , _MetalContrast ) * _MetalColor ) ) , staticSwitch60_g11818);
				float4 appendResult8_g11818 = (float4((lerpResult45_g11818).rgb , (temp_output_1_0_g11818).a));
				float4 staticSwitch28_g11799 = appendResult8_g11818;
				#else
				float4 staticSwitch28_g11799 = staticSwitch26_g11799;
				#endif
				#ifdef _ENABLEFROZEN_ON
				float4 temp_output_1_0_g11812 = staticSwitch28_g11799;
				float4 break2_g11813 = temp_output_1_0_g11812;
				float temp_output_7_0_g11812 = ( ( break2_g11813.x + break2_g11813.x + break2_g11813.y + break2_g11813.y + break2_g11813.y + break2_g11813.z ) / 6.0 );
				float temp_output_9_0_g11815 = max( _FrozenContrast , 0.0 );
				float saferPower7_g11815 = abs( ( temp_output_7_0_g11812 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11815 ) , 0.0 ) ) ) );
				float saferPower20_g11812 = abs( temp_output_7_0_g11812 );
				float2 temp_output_72_0_g11812 = temp_output_41_0_g11799;
				float linValue16_g11814 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11812 * _FrozenSnowScale ) ).r;
				float localMyCustomExpression16_g11814 = MyCustomExpression16_g11814( linValue16_g11814 );
				float temp_output_73_0_g11812 = temp_output_40_0_g11799;
				float linValue16_g11816 = tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g11812 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g11812 ) * _FrozenHighlightDistortionScale ) ).r;
				float localMyCustomExpression16_g11816 = MyCustomExpression16_g11816( linValue16_g11816 );
				float linValue16_g11817 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11816 - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g11812 * _FrozenHighlightSpeed ) + temp_output_72_0_g11812 ) ) * _FrozenHighlightScale ) ).r;
				float localMyCustomExpression16_g11817 = MyCustomExpression16_g11817( linValue16_g11817 );
				float saferPower42_g11812 = abs( temp_output_7_0_g11812 );
				float3 lerpResult57_g11812 = lerp( (temp_output_1_0_g11812).rgb , ( ( pow( saferPower7_g11815 , temp_output_9_0_g11815 ) * (_FrozenTint).rgb ) + ( pow( saferPower20_g11812 , _FrozenSnowContrast ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g11814 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g11817 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( saferPower42_g11812 , _FrozenHighlightContrast ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g11812 = (float4(lerpResult57_g11812 , temp_output_1_0_g11812.a));
				float4 staticSwitch29_g11799 = appendResult26_g11812;
				#else
				float4 staticSwitch29_g11799 = staticSwitch28_g11799;
				#endif
				float4 temp_output_1_0_g11807 = staticSwitch29_g11799;
				float3 temp_output_28_0_g11807 = (temp_output_1_0_g11807).rgb;
				float4 break2_g11811 = float4( temp_output_28_0_g11807 , 0.0 );
				float saferPower21_g11807 = abs( ( ( break2_g11811.x + break2_g11811.x + break2_g11811.y + break2_g11811.y + break2_g11811.y + break2_g11811.z ) / 6.0 ) );
				float2 temp_output_72_0_g11807 = temp_output_41_0_g11799;
				float linValue16_g11810 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11807 * _BurnSwirlNoiseScale ) ).r;
				float localMyCustomExpression16_g11810 = MyCustomExpression16_g11810( linValue16_g11810 );
				float linValue16_g11808 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11810 - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g11807 ) * _BurnInsideNoiseScale ) ).r;
				#ifdef _ENABLEBURN_ON
				float localMyCustomExpression16_g11808 = MyCustomExpression16_g11808( linValue16_g11808 );
				float clampResult68_g11807 = clamp( ( _BurnInsideNoiseFactor - localMyCustomExpression16_g11808 ) , 0.0 , 1.0 );
				float linValue16_g11809 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11807 * _BurnEdgeNoiseScale ) ).r;
				float localMyCustomExpression16_g11809 = MyCustomExpression16_g11809( linValue16_g11809 );
				float temp_output_15_0_g11807 = ( ( ( _BurnRadius - distance( temp_output_72_0_g11807 , _BurnPosition ) ) + ( localMyCustomExpression16_g11809 * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g11807 = clamp( temp_output_15_0_g11807 , 0.0 , 1.0 );
				float3 lerpResult29_g11807 = lerp( temp_output_28_0_g11807 , ( pow( saferPower21_g11807 , max( _BurnInsideContrast , 0.001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g11807 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g11807);
				float3 lerpResult40_g11807 = lerp( temp_output_28_0_g11807 , ( lerpResult29_g11807 + ( ( step( temp_output_15_0_g11807 , 1.0 ) * step( 0.0 , temp_output_15_0_g11807 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g11807 = (float4(lerpResult40_g11807 , temp_output_1_0_g11807.a));
				float4 staticSwitch32_g11799 = appendResult43_g11807;
				#else
				float4 staticSwitch32_g11799 = staticSwitch29_g11799;
				#endif
				#ifdef _ENABLERAINBOW_ON
				float2 temp_output_42_0_g11803 = temp_output_41_0_g11799;
				float linValue16_g11804 = tex2D( _UberNoiseTexture, ( temp_output_42_0_g11803 * _RainbowNoiseScale ) ).r;
				float localMyCustomExpression16_g11804 = MyCustomExpression16_g11804( linValue16_g11804 );
				float3 hsvTorgb3_g11806 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g11803 , _RainbowCenter ) + ( localMyCustomExpression16_g11804 * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g11799 ) ),1.0,1.0) );
				float3 hsvTorgb36_g11803 = RGBToHSV( hsvTorgb3_g11806 );
				float3 hsvTorgb37_g11803 = HSVToRGB( float3(hsvTorgb36_g11803.x,_RainbowSaturation,( hsvTorgb36_g11803.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g11803 = staticSwitch32_g11799;
				float4 break2_g11805 = temp_output_1_0_g11803;
				float saferPower24_g11803 = abs( ( ( break2_g11805.x + break2_g11805.x + break2_g11805.y + break2_g11805.y + break2_g11805.y + break2_g11805.z ) / 6.0 ) );
				float4 appendResult29_g11803 = (float4(( ( hsvTorgb37_g11803 * pow( saferPower24_g11803 , max( _RainbowContrast , 0.001 ) ) * _RainbowFade ) + (temp_output_1_0_g11803).rgb ) , temp_output_1_0_g11803.a));
				float4 staticSwitch34_g11799 = appendResult29_g11803;
				#else
				float4 staticSwitch34_g11799 = staticSwitch32_g11799;
				#endif
				float4 temp_output_1_0_g11800 = staticSwitch34_g11799;
				float3 temp_output_57_0_g11800 = (temp_output_1_0_g11800).rgb;
				float4 break2_g11801 = temp_output_1_0_g11800;
				float3 temp_cast_68 = (( ( break2_g11801.x + break2_g11801.x + break2_g11801.y + break2_g11801.y + break2_g11801.y + break2_g11801.z ) / 6.0 )).xxx;
				float3 lerpResult92_g11800 = lerp( temp_cast_68 , temp_output_57_0_g11800 , _ShineSaturation);
				float3 saferPower83_g11800 = abs( lerpResult92_g11800 );
				float3 temp_cast_69 = (max( _ShineContrast , 0.001 )).xxx;
				float3 rotatedValue69_g11800 = RotateAroundAxis( float3( 0,0,0 ), float3( ( _ShineFrequency * temp_output_41_0_g11799 ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 180.0 ) * UNITY_PI ) );
				float temp_output_103_0_g11800 = ( _ShineFrequency * _ShineWidth );
				float clampResult80_g11800 = clamp( ( ( sin( ( rotatedValue69_g11800.x - ( temp_output_40_0_g11799 * _ShineSpeed * _ShineFrequency ) ) ) - ( 1.0 - temp_output_103_0_g11800 ) ) / temp_output_103_0_g11800 ) , 0.0 , 1.0 );
				#ifdef _SHINEMASKTOGGLE_ON
				float2 uv_ShineMask = IN.texcoord.xy * _ShineMask_ST.xy + _ShineMask_ST.zw;
				float4 tex2DNode3_g11802 = tex2D( _ShineMask, uv_ShineMask );
				float staticSwitch98_g11800 = ( _ShineFade * ( tex2DNode3_g11802.r * tex2DNode3_g11802.a ) );
				#else
				float staticSwitch98_g11800 = _ShineFade;
				#endif
				#ifdef _ENABLESHINE_ON
				float4 appendResult8_g11800 = (float4(( temp_output_57_0_g11800 + ( ( pow( saferPower83_g11800 , temp_cast_69 ) * (_ShineColor).rgb ) * clampResult80_g11800 * staticSwitch98_g11800 ) ) , (temp_output_1_0_g11800).a));
				float4 staticSwitch36_g11799 = appendResult8_g11800;
				#else
				float4 staticSwitch36_g11799 = staticSwitch34_g11799;
				#endif
				#ifdef _ENABLEPOISON_ON
				float temp_output_41_0_g11830 = temp_output_40_0_g11799;
				float linValue16_g11832 = tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g11830 * _PoisonNoiseSpeed ) + temp_output_41_0_g11799 ) * _PoisonNoiseScale ) ).r;
				float localMyCustomExpression16_g11832 = MyCustomExpression16_g11832( linValue16_g11832 );
				float saferPower19_g11830 = abs( abs( ( ( ( localMyCustomExpression16_g11832 + ( temp_output_41_0_g11830 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) );
				float3 temp_output_24_0_g11830 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g11830 = staticSwitch36_g11799;
				float3 temp_output_28_0_g11830 = (temp_output_1_0_g11830).rgb;
				float4 break2_g11831 = float4( temp_output_28_0_g11830 , 0.0 );
				float3 lerpResult32_g11830 = lerp( temp_output_28_0_g11830 , ( temp_output_24_0_g11830 * ( ( break2_g11831.x + break2_g11831.x + break2_g11831.y + break2_g11831.y + break2_g11831.y + break2_g11831.z ) / 6.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g11830 = (float4(( ( max( pow( saferPower19_g11830 , _PoisonDensity ) , 0.0 ) * temp_output_24_0_g11830 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g11830 ) , temp_output_1_0_g11830.a));
				float4 staticSwitch39_g11799 = appendResult27_g11830;
				#else
				float4 staticSwitch39_g11799 = staticSwitch36_g11799;
				#endif
				float4 temp_output_10_0_g11833 = staticSwitch39_g11799;
				float3 temp_output_12_0_g11833 = (temp_output_10_0_g11833).rgb;
				float2 temp_output_2_0_g11833 = temp_output_41_0_g11799;
				float temp_output_1_0_g11833 = temp_output_40_0_g11799;
				float2 temp_output_6_0_g11833 = ( temp_output_1_0_g11833 * _EnchantedSpeed );
				float linValue16_g11836 = tex2D( _UberNoiseTexture, ( ( ( temp_output_2_0_g11833 - ( ( temp_output_6_0_g11833 + float2( 1.234,5.6789 ) ) * float2( 0.95,1.05 ) ) ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11836 = MyCustomExpression16_g11836( linValue16_g11836 );
				float linValue16_g11834 = tex2D( _UberNoiseTexture, ( ( ( temp_output_6_0_g11833 + temp_output_2_0_g11833 ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11834 = MyCustomExpression16_g11834( linValue16_g11834 );
				float temp_output_36_0_g11833 = ( localMyCustomExpression16_g11836 + localMyCustomExpression16_g11834 );
				float temp_output_43_0_g11833 = ( temp_output_36_0_g11833 * 0.5 );
				float3 lerpResult42_g11833 = lerp( (_EnchantedLowColor).rgb , (_EnchantedHighColor).rgb , temp_output_43_0_g11833);
				#ifdef _ENCHANTEDRAINBOWTOGGLE_ON
				float3 hsvTorgb53_g11833 = HSVToRGB( float3(( ( temp_output_43_0_g11833 * _EnchantedRainbowDensity ) + ( _EnchantedRainbowSpeed * temp_output_1_0_g11833 ) ),_EnchantedRainbowSaturation,1.0) );
				float3 staticSwitch50_g11833 = hsvTorgb53_g11833;
				#else
				float3 staticSwitch50_g11833 = lerpResult42_g11833;
				#endif
				float4 break2_g11835 = temp_output_10_0_g11833;
				float saferPower24_g11833 = abs( ( ( break2_g11835.x + break2_g11835.x + break2_g11835.y + break2_g11835.y + break2_g11835.y + break2_g11835.z ) / 6.0 ) );
				float3 temp_output_40_0_g11833 = ( staticSwitch50_g11833 * pow( saferPower24_g11833 , _EnchantedContrast ) * _EnchantedBrightness );
				float temp_output_45_0_g11833 = ( max( ( temp_output_36_0_g11833 - _EnchantedReduce ) , 0.0 ) * _EnchantedFade );
				#ifdef _ENCHANTEDLERPTOGGLE_ON
				float3 lerpResult44_g11833 = lerp( temp_output_12_0_g11833 , temp_output_40_0_g11833 , temp_output_45_0_g11833);
				float3 staticSwitch47_g11833 = lerpResult44_g11833;
				#else
				float3 staticSwitch47_g11833 = ( temp_output_12_0_g11833 + ( temp_output_40_0_g11833 * temp_output_45_0_g11833 ) );
				#endif
				#ifdef _ENABLEENCHANTED_ON
				float4 appendResult19_g11833 = (float4(staticSwitch47_g11833 , temp_output_10_0_g11833.a));
				float4 staticSwitch11_g11833 = appendResult19_g11833;
				#else
				float4 staticSwitch11_g11833 = temp_output_10_0_g11833;
				#endif
				float4 temp_output_1_0_g11837 = staticSwitch11_g11833;
				float4 break5_g11837 = temp_output_1_0_g11837;
				float3 appendResult32_g11837 = (float3(break5_g11837.r , break5_g11837.g , break5_g11837.b));
				float4 break2_g11838 = temp_output_1_0_g11837;
				float temp_output_4_0_g11837 = ( ( break2_g11838.x + break2_g11838.x + break2_g11838.y + break2_g11838.y + break2_g11838.y + break2_g11838.z ) / 6.0 );
				float temp_output_11_0_g11837 = ( ( ( temp_output_4_0_g11837 + ( temp_output_40_0_g11799 * _ShiftingSpeed ) ) * _ShiftingDensity ) % 1.0 );
				float3 lerpResult20_g11837 = lerp( (_ShiftingColorA).rgb , (_ShiftingColorB).rgb , ( abs( ( temp_output_11_0_g11837 - 0.5 ) ) * 2.0 ));
				#ifdef _SHIFTINGRAINBOWTOGGLE_ON
				float3 hsvTorgb12_g11837 = HSVToRGB( float3(temp_output_11_0_g11837,_ShiftingSaturation,_ShiftingBrightness) );
				float3 staticSwitch26_g11837 = hsvTorgb12_g11837;
				#else
				float3 staticSwitch26_g11837 = ( lerpResult20_g11837 * _ShiftingBrightness );
				#endif
				#ifdef _ENABLESHIFTING_ON
				float3 lerpResult31_g11837 = lerp( appendResult32_g11837 , ( staticSwitch26_g11837 * pow( temp_output_4_0_g11837 , _ShiftingContrast ) ) , _ShiftingFade);
				float4 appendResult6_g11837 = (float4(lerpResult31_g11837 , break5_g11837.a));
				float4 staticSwitch33_g11837 = appendResult6_g11837;
				#else
				float4 staticSwitch33_g11837 = temp_output_1_0_g11837;
				#endif
				float4 temp_output_473_0 = staticSwitch33_g11837;
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 break4_g11839 = temp_output_473_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g11839 = (float4(break4_g11839.r , break4_g11839.g , break4_g11839.b , ( break4_g11839.a * fullDistortionAlpha164 )));
				float4 staticSwitch77 = appendResult5_g11839;
				#else
				float4 staticSwitch77 = temp_output_473_0;
				#endif
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 break4_g11840 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g11668 ) ):( clampResult154_g11668 ));
				float4 appendResult5_g11840 = (float4(break4_g11840.r , break4_g11840.g , break4_g11840.b , ( break4_g11840.a * directionalDistortionAlpha167 )));
				float4 staticSwitch75 = appendResult5_g11840;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g11841 = staticSwitch75;
				float4 temp_output_1_0_g11842 = temp_output_1_0_g11841;
				float temp_output_53_0_g11842 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g11841 = shaderPosition235;
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float linValue16_g11843 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11841 * _FullAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11843 = MyCustomExpression16_g11843( linValue16_g11843 );
				float clampResult17_g11842 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g11842 ) ) - localMyCustomExpression16_g11843 ) / temp_output_53_0_g11842 ) , 0.0 , 1.0 );
				float4 appendResult3_g11842 = (float4((temp_output_1_0_g11842).rgb , ( temp_output_1_0_g11842.a * clampResult17_g11842 )));
				float4 staticSwitch3_g11841 = appendResult3_g11842;
				#else
				float4 staticSwitch3_g11841 = temp_output_1_0_g11841;
				#endif
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float linValue16_g11851 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11841 * _FullGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11851 = MyCustomExpression16_g11851( linValue16_g11851 );
				float temp_output_5_0_g11850 = localMyCustomExpression16_g11851;
				float temp_output_61_0_g11850 = step( temp_output_5_0_g11850 , _FullGlowDissolveFade );
				float temp_output_53_0_g11850 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g11850 = staticSwitch3_g11841;
				float4 appendResult3_g11850 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g11850 - step( temp_output_5_0_g11850 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g11850 ) ) - temp_output_53_0_g11850 ) ) ) ) + (temp_output_1_0_g11850).rgb ) , ( temp_output_1_0_g11850.a * temp_output_61_0_g11850 )));
				float4 staticSwitch5_g11841 = appendResult3_g11850;
				#else
				float4 staticSwitch5_g11841 = staticSwitch3_g11841;
				#endif
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 temp_output_1_0_g11852 = staticSwitch5_g11841;
				float2 temp_output_76_0_g11852 = temp_output_18_0_g11841;
				float linValue16_g11853 = tex2D( _UberNoiseTexture, ( temp_output_76_0_g11852 * _SourceAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11853 = MyCustomExpression16_g11853( linValue16_g11853 );
				float clampResult17_g11852 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g11852 ) + ( localMyCustomExpression16_g11853 * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11852 = (float4((temp_output_1_0_g11852).rgb , ( temp_output_1_0_g11852.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g11852 ) ):( clampResult17_g11852 )) )));
				float4 staticSwitch8_g11841 = appendResult3_g11852;
				#else
				float4 staticSwitch8_g11841 = staticSwitch5_g11841;
				#endif
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float2 temp_output_90_0_g11848 = temp_output_18_0_g11841;
				float linValue16_g11849 = tex2D( _UberNoiseTexture, ( temp_output_90_0_g11848 * _SourceGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11849 = MyCustomExpression16_g11849( linValue16_g11849 );
				float temp_output_65_0_g11848 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g11848 ) + ( localMyCustomExpression16_g11849 * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g11848 = step( temp_output_65_0_g11848 , _SourceGlowDissolveFade );
				float temp_output_76_0_g11848 = step( temp_output_65_0_g11848 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g11848 = staticSwitch8_g11841;
				float4 appendResult3_g11848 = (float4(( ( max( ( temp_output_75_0_g11848 - temp_output_76_0_g11848 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g11848).rgb ) , ( temp_output_1_0_g11848.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g11848 ) ):( temp_output_75_0_g11848 )) )));
				float4 staticSwitch9_g11841 = appendResult3_g11848;
				#else
				float4 staticSwitch9_g11841 = staticSwitch8_g11841;
				#endif
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 temp_output_1_0_g11844 = staticSwitch9_g11841;
				float2 temp_output_161_0_g11844 = temp_output_18_0_g11841;
				float3 rotatedValue136_g11844 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g11844 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11844 = rotatedValue136_g11844;
				float linValue16_g11845 = tex2D( _UberNoiseTexture, ( temp_output_161_0_g11844 * _DirectionalAlphaFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11845 = MyCustomExpression16_g11845( linValue16_g11845 );
				float clampResult154_g11844 = clamp( ( ( break130_g11844.x + break130_g11844.y + _DirectionalAlphaFadeFade + ( localMyCustomExpression16_g11845 * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11844 = (float4((temp_output_1_0_g11844).rgb , ( temp_output_1_0_g11844.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g11844 ) ):( clampResult154_g11844 )) )));
				float4 staticSwitch11_g11841 = appendResult3_g11844;
				#else
				float4 staticSwitch11_g11841 = staticSwitch9_g11841;
				#endif
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float2 temp_output_171_0_g11846 = temp_output_18_0_g11841;
				float3 rotatedValue136_g11846 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g11846 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11846 = rotatedValue136_g11846;
				float linValue16_g11847 = tex2D( _UberNoiseTexture, ( temp_output_171_0_g11846 * _DirectionalGlowFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11847 = MyCustomExpression16_g11847( linValue16_g11847 );
				float temp_output_168_0_g11846 = max( ( ( break130_g11846.x + break130_g11846.y + _DirectionalGlowFadeFade + ( localMyCustomExpression16_g11847 * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g11846 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11846 ) ):( temp_output_168_0_g11846 )) );
				float4 temp_output_1_0_g11846 = staticSwitch11_g11841;
				float clampResult154_g11846 = clamp( temp_output_161_0_g11846 , 0.0 , 1.0 );
				float4 appendResult3_g11846 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g11846 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11846 ) ):( temp_output_168_0_g11846 )) ) ) ) + (temp_output_1_0_g11846).rgb ) , ( temp_output_1_0_g11846.a * clampResult154_g11846 )));
				float4 staticSwitch15_g11841 = appendResult3_g11846;
				#else
				float4 staticSwitch15_g11841 = staticSwitch11_g11841;
				#endif
				float4 temp_output_1_0_g11854 = staticSwitch15_g11841;
				float2 temp_output_126_0_g11854 = temp_output_18_0_g11841;
				float temp_output_121_0_g11854 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g11854 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g11855 = (float2(temp_output_121_0_g11854 , temp_output_121_0_g11854));
				float temp_output_17_0_g11855 = length( ( (( ( abs( temp_output_126_0_g11854 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g11855 ) );
				#ifdef _ENABLEHALFTONE_ON
				float clampResult17_g11854 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g11855 ) / fwidth( temp_output_17_0_g11855 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11854 = (float4((temp_output_1_0_g11854).rgb , ( temp_output_1_0_g11854.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g11854 ) ):( clampResult17_g11854 )) )));
				float4 staticSwitch13_g11841 = appendResult3_g11854;
				#else
				float4 staticSwitch13_g11841 = staticSwitch15_g11841;
				#endif
				float3 temp_output_3_0_g11857 = (_AddColorColor).rgb;
				#ifdef _ADDCOLORMASKTOGGLE_ON
				float2 uv_AddColorMask = IN.texcoord.xy * _AddColorMask_ST.xy + _AddColorMask_ST.zw;
				float4 tex2DNode19_g11857 = tex2D( _AddColorMask, uv_AddColorMask );
				float3 staticSwitch16_g11857 = ( temp_output_3_0_g11857 * ( (tex2DNode19_g11857).rgb * tex2DNode19_g11857.a ) );
				#else
				float3 staticSwitch16_g11857 = temp_output_3_0_g11857;
				#endif
				float4 temp_output_1_0_g11857 = staticSwitch13_g11841;
				#ifdef _ADDCOLORCONTRASTTOGGLE_ON
				float4 break2_g11859 = temp_output_1_0_g11857;
				float temp_output_9_0_g11858 = max( _AddColorContrast , 0.0 );
				float saferPower7_g11858 = abs( ( ( ( break2_g11859.x + break2_g11859.x + break2_g11859.y + break2_g11859.y + break2_g11859.y + break2_g11859.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11858 ) , 0.0 ) ) ) );
				float3 staticSwitch17_g11857 = ( staticSwitch16_g11857 * pow( saferPower7_g11858 , temp_output_9_0_g11858 ) );
				#else
				float3 staticSwitch17_g11857 = staticSwitch16_g11857;
				#endif
				#ifdef _ENABLEADDCOLOR_ON
				float4 appendResult6_g11857 = (float4(( ( staticSwitch17_g11857 * _AddColorFade ) + (temp_output_1_0_g11857).rgb ) , temp_output_1_0_g11857.a));
				float4 staticSwitch5_g11856 = appendResult6_g11857;
				#else
				float4 staticSwitch5_g11856 = staticSwitch13_g11841;
				#endif
				#ifdef _ENABLEALPHATINT_ON
				float4 temp_output_1_0_g11860 = staticSwitch5_g11856;
				float3 lerpResult4_g11860 = lerp( (temp_output_1_0_g11860).rgb , (_AlphaTintColor).rgb , ( ( 1.0 - temp_output_1_0_g11860.a ) * step( _AlphaTintMinAlpha , temp_output_1_0_g11860.a ) * _AlphaTintFade ));
				float4 appendResult13_g11860 = (float4(lerpResult4_g11860 , temp_output_1_0_g11860.a));
				float4 staticSwitch11_g11856 = appendResult13_g11860;
				#else
				float4 staticSwitch11_g11856 = staticSwitch5_g11856;
				#endif
				float4 temp_output_1_0_g11861 = staticSwitch11_g11856;
				float3 temp_output_6_0_g11861 = (_StrongTintTint).rgb;
				#ifdef _STRONGTINTMASKTOGGLE_ON
				float2 uv_StrongTintMask = IN.texcoord.xy * _StrongTintMask_ST.xy + _StrongTintMask_ST.zw;
				float4 tex2DNode23_g11861 = tex2D( _StrongTintMask, uv_StrongTintMask );
				float3 staticSwitch21_g11861 = ( temp_output_6_0_g11861 * ( (tex2DNode23_g11861).rgb * tex2DNode23_g11861.a ) );
				#else
				float3 staticSwitch21_g11861 = temp_output_6_0_g11861;
				#endif
				#ifdef _STRONGTINTCONTRASTTOGGLE_ON
				float4 break2_g11863 = temp_output_1_0_g11861;
				float temp_output_9_0_g11862 = max( _StrongTintContrast , 0.0 );
				float saferPower7_g11862 = abs( ( ( ( break2_g11863.x + break2_g11863.x + break2_g11863.y + break2_g11863.y + break2_g11863.y + break2_g11863.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11862 ) , 0.0 ) ) ) );
				float3 staticSwitch22_g11861 = ( pow( saferPower7_g11862 , temp_output_9_0_g11862 ) * staticSwitch21_g11861 );
				#else
				float3 staticSwitch22_g11861 = staticSwitch21_g11861;
				#endif
				#ifdef _ENABLESTRONGTINT_ON
				float3 lerpResult7_g11861 = lerp( (temp_output_1_0_g11861).rgb , staticSwitch22_g11861 , _StrongTintFade);
				float4 appendResult9_g11861 = (float4(lerpResult7_g11861 , (temp_output_1_0_g11861).a));
				float4 staticSwitch7_g11856 = appendResult9_g11861;
				#else
				float4 staticSwitch7_g11856 = staticSwitch11_g11856;
				#endif
				float4 temp_output_2_0_g11864 = staticSwitch7_g11856;
				#ifdef _ENABLESHADOW_ON
				float4 break4_g11866 = temp_output_2_0_g11864;
				float3 appendResult5_g11866 = (float3(break4_g11866.r , break4_g11866.g , break4_g11866.b));
				float2 appendResult2_g11865 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float4 appendResult85_g11864 = (float4(_ShadowColor.r , _ShadowColor.g , _ShadowColor.b , ( _ShadowFade * tex2D( _MainTex, ( finalUV146 - ( ( 100.0 / appendResult2_g11865 ) * _ShadowOffset ) ) ).a )));
				float4 break6_g11866 = appendResult85_g11864;
				float3 appendResult7_g11866 = (float3(break6_g11866.r , break6_g11866.g , break6_g11866.b));
				float temp_output_11_0_g11866 = ( ( 1.0 - break4_g11866.a ) * break6_g11866.a );
				float temp_output_32_0_g11866 = ( break4_g11866.a + temp_output_11_0_g11866 );
				float4 appendResult18_g11866 = (float4(( ( ( appendResult5_g11866 * break4_g11866.a ) + ( appendResult7_g11866 * temp_output_11_0_g11866 ) ) * ( 1.0 / max( temp_output_32_0_g11866 , 0.01 ) ) ) , temp_output_32_0_g11866));
				float4 staticSwitch82_g11864 = appendResult18_g11866;
				#else
				float4 staticSwitch82_g11864 = temp_output_2_0_g11864;
				#endif
				float4 break4_g11867 = staticSwitch82_g11864;
				#ifdef _ENABLECUSTOMFADE_ON
				float staticSwitch8_g11747 = 1.0;
				#else
				float staticSwitch8_g11747 = IN.color.a;
				#endif
				#ifdef _ENABLESMOKE_ON
				float staticSwitch9_g11747 = 1.0;
				#else
				float staticSwitch9_g11747 = staticSwitch8_g11747;
				#endif
				float customVertexAlpha193 = staticSwitch9_g11747;
				float4 appendResult5_g11867 = (float4(break4_g11867.r , break4_g11867.g , break4_g11867.b , ( break4_g11867.a * customVertexAlpha193 )));
				float4 temp_output_344_0 = appendResult5_g11867;
				float4 temp_output_1_0_g11869 = temp_output_344_0;
				float4 appendResult8_g11869 = (float4(( (temp_output_1_0_g11869).rgb * (IN.color).rgb ) , temp_output_1_0_g11869.a));
				#ifdef _VERTEXTINTFIRST_ON
				float4 staticSwitch342 = temp_output_344_0;
				#else
				float4 staticSwitch342 = appendResult8_g11869;
				#endif
				...
				float4 staticSwitch143 = staticSwitch342;
				#endif
				float4 temp_output_7_0_g11875 = staticSwitch143;
				#ifdef _BAKEDMATERIAL_ON
				float4 appendResult2_g11875 = (float4(( (temp_output_7_0_g11875).rgb / max( temp_output_7_0_g11875.a , 1E-05 ) ) , temp_output_7_0_g11875.a));
				float4 staticSwitch6_g11875 = appendResult2_g11875;
				#else
				float4 staticSwitch6_g11875 = temp_output_7_0_g11875;
				#endif
				
				fixed4 c = staticSwitch6_g11875;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=19002
248;166;1837;1046;-4320.514;2344.387;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;292;5091.561,1459.408;Inherit;False;ShaderMasker;-1;;11706;3d25b55dbfdd24f48b9bd371bdde0e97;0;2;1;FLOAT;0;False;2;SAMPLER2D;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;221;;11711;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;431;;11713;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11725;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;11726;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-1990.589,-315.832;Inherit;False;_UberSample;530;;11727;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;358;-1921.027,-115.7738;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;356;-1686.027,-106.7738;Inherit;False;ColorMultiply;-1;;11746;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;541;;11747;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;515;;11752;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;361;-136.8644,-329.1863;Inherit;False;_UberColor;60;;11756;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-37.83691,-91.99512;Inherit;False;182;hologramFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;195;;11792;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;215;;11795;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;473;1656.25,-345.9998;Inherit;False;_UberEffect;226;;11799;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;78;2104.106,-267.8359;Inherit;False;AlphaMultiply;-1;;11839;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;76;3014.405,-219.2272;Inherit;False;AlphaMultiply;-1;;11840;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;354;;11841;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;478;4200.417,-206.2577;Inherit;False;_UberColorFinal;33;;11856;6ac57aba23ea6404ba71b6806ea93971;0;3;14;FLOAT2;0,0;False;15;SAMPLER2D;;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;344;4548.086,-90.46628;Inherit;False;AlphaMultiply;-1;;11867;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;353;4889.3,-222.093;Inherit;False;ColorMultiply;-1;;11869;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;510;;11868;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4877.096,136.7432;Inherit;False;TintVertex;-1;;11870;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;476;;11871;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;340;6010.595,-19.64009;Inherit;False;BakingHandler;6;;11875;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=0903A7DBD86478F7F0445652EDE3E3D15332B2DF
