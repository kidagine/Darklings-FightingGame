	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				#ifdef _ENABLESQUISH_ON
				float2 break77_g12265 = fixedUV475;
				float2 appendResult72_g12265 = (float2(( _SquishStretch * ( break77_g12265.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g12265.y + _SquishFlip ) * -_SquishSquish )));
				float2 staticSwitch198 = ( appendResult72_g12265 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g12268 = staticSwitch198;
				#ifdef _TOGGLECUSTOMTIME_ON
				...
				float temp_output_8_0_g12268 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g12268 = ( ( sin( ( temp_output_8_0_g12268 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g12268 );
				#else
				float2 staticSwitch4_g12268 = temp_output_2_0_g12268;
				#endif
				#ifdef _ENABLEVIBRATE_ON
				float temp_output_30_0_g12269 = temp_output_8_0_g12268;
				float3 rotatedValue21_g12269 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g12269 * _VibrateRotation ) );
				float2 staticSwitch6_g12268 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g12269 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g12269).xy ) + staticSwitch4_g12268 );
				#else
				float2 staticSwitch6_g12268 = staticSwitch4_g12268;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g12268 = ( staticSwitch6_g12268 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g12268 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
				float2 staticSwitch10_g12268 = staticSwitch6_g12268;
				#endif
				float2 temp_output_424_0 = staticSwitch10_g12268;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float linValue16_g11722 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				...
				#ifdef _ENABLEGLITCH_ON
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11722 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				float2 staticSwitch62 = staticSwitch59;
				#endif
				float2 temp_output_1_0_g11723 = staticSwitch62;
				float2 temp_output_26_0_g11723 = shaderPosition235;
				float temp_output_25_0_g11723 = shaderTime237;
				float linValue16_g11733 = tex2D( _UberNoiseTexture, ( ( temp_output_26_0_g11723 + ( _UVDistortSpeed * temp_output_25_0_g11723 ) ) * _UVDistortNoiseScale ) ).r;
				float localMyCustomExpression16_g11733 = MyCustomExpression16_g11733( linValue16_g11733 );
				float2 lerpResult21_g11730 = lerp( _UVDistortFrom , _UVDistortTo , localMyCustomExpression16_g11733);
				float2 appendResult2_g11732 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				#ifdef _UVDISTORTMASKTOGGLE_ON
				float2 uv_UVDistortMask = IN.texcoord.xy * _UVDistortMask_ST.xy + _UVDistortMask_ST.zw;
				float4 tex2DNode3_g11731 = tex2D( _UVDistortMask, uv_UVDistortMask );
				float staticSwitch29_g11730 = ( _UVDistortFade * ( tex2DNode3_g11731.r * tex2DNode3_g11731.a ) );
				#else
				float staticSwitch29_g11730 = _UVDistortFade;
				#endif
				#ifdef _ENABLEUVDISTORT_ON
				float2 staticSwitch5_g11723 = ( temp_output_1_0_g11723 + ( lerpResult21_g11730 * ( 100.0 / appendResult2_g11732 ) * staticSwitch29_g11730 ) );
				#else
				float2 staticSwitch5_g11723 = temp_output_1_0_g11723;
				#endif
				#ifdef _ENABLESQUEEZE_ON
				float2 temp_output_1_0_g11729 = staticSwitch5_g11723;
				float2 staticSwitch7_g11723 = ( temp_output_1_0_g11729 + ( ( temp_output_1_0_g11729 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g11729 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g11723 = staticSwitch5_g11723;
				#endif
				#ifdef _ENABLESINEROTATE_ON
				float3 rotatedValue36_g11728 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g11723 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g11723 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				float2 staticSwitch9_g11723 = (rotatedValue36_g11728).xy;
				#else
				float2 staticSwitch9_g11723 = staticSwitch7_g11723;
				#endif
				#ifdef _ENABLEUVROTATE_ON
				float3 rotatedValue8_g11727 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g11723 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g11723 * _UVRotateSpeed * UNITY_PI ) );
				float2 staticSwitch16_g11723 = (rotatedValue8_g11727).xy;
				#else
				float2 staticSwitch16_g11723 = staticSwitch9_g11723;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g11723 = ( ( _UVScrollSpeed * temp_output_25_0_g11723 ) + staticSwitch16_g11723 );
				#else
				float2 staticSwitch14_g11723 = staticSwitch16_g11723;
				#endif
				#ifdef _ENABLEPIXELATE_ON
				float2 appendResult35_g11725 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g11725 = ( ( _PixelatePixelDensity * ( appendResult35_g11725 / _PixelatePixelsPerUnit ) ) * ( 1.0 / max( _PixelateFade , 1E-05 ) ) );
				float2 clampResult46_g11725 = clamp( ( floor( ( MultFactor30_g11725 * ( staticSwitch14_g11723 + ( float2( 0.5,0.5 ) / MultFactor30_g11725 ) ) ) ) / MultFactor30_g11725 ) , float2( 0,0 ) , float2( 1,1 ) );
				float2 staticSwitch4_g11723 = clampResult46_g11725;
				#else
				float2 staticSwitch4_g11723 = staticSwitch14_g11723;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g11723 = ( ( ( staticSwitch4_g11723 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g11723 = staticSwitch4_g11723;
				#endif
				float2 temp_output_1_0_g11734 = staticSwitch24_g11723;
				float temp_output_7_0_g11734 = ( sin( ( _WiggleFrequency * ( temp_output_26_0_g11723.y + ( _WiggleSpeed * temp_output_25_0_g11723 ) ) ) ) * _WiggleOffset * _WiggleFade );
				#ifdef _WIGGLEFIXEDGROUNDTOGGLE_ON
				float staticSwitch18_g11734 = ( temp_output_7_0_g11734 * temp_output_1_0_g11734.y );
				#else
				float staticSwitch18_g11734 = temp_output_7_0_g11734;
				#endif
				#ifdef _ENABLEWIGGLE_ON
				float2 appendResult12_g11734 = (float2(staticSwitch18_g11734 , 0.0));
				float2 staticSwitch13_g11734 = ( temp_output_1_0_g11734 + appendResult12_g11734 );
				#else
				float2 staticSwitch13_g11734 = temp_output_1_0_g11734;
				#endif
				float2 temp_output_484_0 = staticSwitch13_g11734;
				...
				#endif
				#ifdef _SPRITESHEETFIX_ON
				float2 break14_g11735 = staticSwitch485;
				float2 break11_g11735 = float2( 0,0 );
				float2 break10_g11735 = float2( 1,1 );
				float2 break9_g11735 = spriteRectMin376;
				float2 break8_g11735 = spriteRectMax377;
				float2 appendResult15_g11735 = (float2((break9_g11735.x + (break14_g11735.x - break11_g11735.x) * (break8_g11735.x - break9_g11735.x) / (break10_g11735.x - break11_g11735.x)) , (break9_g11735.y + (break14_g11735.y - break11_g11735.y) * (break8_g11735.y - break9_g11735.y) / (break10_g11735.y - break11_g11735.y))));
				float2 staticSwitch371 = min( max( appendResult15_g11735 , spriteRectMin376 ) , spriteRectMax377 );
				#else
				float2 staticSwitch371 = staticSwitch485;
				#endif
				#ifdef _PIXELPERFECTUV_ON
				float2 appendResult7_g11736 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g11736 ) ) / appendResult7_g11736 ) );
				#else
				float2 staticSwitch427 = staticSwitch371;
				#endif
				float2 finalUV146 = staticSwitch427;
				float2 temp_output_1_0_g11737 = finalUV146;
				#ifdef _ENABLESMOOTHPIXELART_ON
				sampler2D tex3_g11738 = _MainTex;
				float4 textureTexelSize3_g11738 = _MainTex_TexelSize;
				float2 uvs3_g11738 = temp_output_1_0_g11737;
				float4 localtexturePointSmooth3_g11738 = texturePointSmooth( tex3_g11738 , textureTexelSize3_g11738 , uvs3_g11738 );
				float4 staticSwitch8_g11737 = localtexturePointSmooth3_g11738;
				#else
				float4 staticSwitch8_g11737 = tex2D( _MainTex, temp_output_1_0_g11737 );
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float temp_output_10_0_g11739 = ( _GaussianBlurOffset * _GaussianBlurFade * 0.005 );
				float temp_output_2_0_g11749 = temp_output_10_0_g11739;
				...
				float2 temp_output_7_0_g11739 = temp_output_1_0_g11737;
				float2 temp_output_1_0_g11749 = ( temp_output_7_0_g11739 + ( temp_output_10_0_g11739 * float2( 1,1 ) ) );
				...
				float temp_output_2_0_g11740 = temp_output_10_0_g11739;
				...
				float2 temp_output_1_0_g11740 = ( temp_output_7_0_g11739 + ( temp_output_10_0_g11739 * float2( -1,1 ) ) );
				...
				float temp_output_2_0_g11746 = temp_output_10_0_g11739;
				...
				float2 temp_output_1_0_g11746 = ( temp_output_7_0_g11739 + ( temp_output_10_0_g11739 * float2( -1,-1 ) ) );
				...
				float temp_output_2_0_g11743 = temp_output_10_0_g11739;
				...
				float2 temp_output_1_0_g11743 = ( temp_output_7_0_g11739 + ( temp_output_10_0_g11739 * float2( 1,-1 ) ) );
				...
				float4 staticSwitch3_g11737 = ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11751 + temp_output_1_0_g11751 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11751 + temp_output_1_0_g11751 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11750 + temp_output_1_0_g11750 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11750 + temp_output_1_0_g11750 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11748 + temp_output_1_0_g11748 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11748 + temp_output_1_0_g11748 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11747 + temp_output_1_0_g11747 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11747 + temp_output_1_0_g11747 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11744 + temp_output_1_0_g11744 ) ) ) ) ) * 0.0625 );
				#else
				float4 staticSwitch3_g11737 = staticSwitch8_g11737;
				#endif
				#ifdef _ENABLESHARPEN_ON
				float2 temp_output_1_0_g11752 = temp_output_1_0_g11737;
				float4 tex2DNode4_g11752 = tex2D( _MainTex, temp_output_1_0_g11752 );
				float temp_output_2_0_g11753 = _SharpenOffset;
				...
				float4 break22_g11752 = ( tex2DNode4_g11752 - ( ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11755 + temp_output_1_0_g11755 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11755 + temp_output_1_0_g11755 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11754 + temp_output_1_0_g11754 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11754 + temp_output_1_0_g11754 ) ) ) ) / 4.0 ) - tex2DNode4_g11752 ) * ( _SharpenFactor * _SharpenFade ) ) );
				float clampResult23_g11752 = clamp( break22_g11752.a , 0.0 , 1.0 );
				float4 appendResult24_g11752 = (float4(break22_g11752.r , break22_g11752.g , break22_g11752.b , clampResult23_g11752));
				float4 staticSwitch12_g11737 = appendResult24_g11752;
				#else
				float4 staticSwitch12_g11737 = staticSwitch3_g11737;
				#endif
				float4 temp_output_1_0_g12139 = staticSwitch12_g11737;
				#ifdef _ISTEXT_ON
				...
				float4 staticSwitch143 = staticSwitch342;
				#endif
				float4 temp_output_7_0_g12272 = staticSwitch143;
				#ifdef _BAKEDMATERIAL_ON
				float4 appendResult2_g12272 = (float4(( (temp_output_7_0_g12272).rgb / max( temp_output_7_0_g12272.a , 1E-05 ) ) , temp_output_7_0_g12272.a));
				float4 staticSwitch6_g12272 = appendResult2_g12272;
				#else
				float4 staticSwitch6_g12272 = temp_output_7_0_g12272;
				#endif
				
				half4 color = staticSwitch6_g12272;
...
/*ASEBEGIN
Version=19002
248;166;1837;1046;2682.141;2287.536;2.5;True;False
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;226;;11721;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;436;;11723;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11735;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;11736;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-2266.589,-335.832;Inherit;False;_UberSample;535;;11737;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;515;;12265;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;124;4962.062,258.7927;Inherit;False;123;fullFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;195;4877.096,136.7432;Inherit;False;TintVertex;-1;;12267;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;481;;12268;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;340;6010.595,-19.64009;Inherit;False;BakingHandler;11;;12272;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;489;6391.947,126.1744;Float;False;True;-1;2;SpriteShadersUltimate.SSUShaderGUI;0;6;Sprite Shaders Ultimate/Additive GUI SSU;5056123faa0c79b47ab6ad7e8bf059a4;True;Default;0;0;Default;2;True;True;8;5;False;;1;False;;3;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;True;True;True;True;True;0;True;_ColorMask;False;False;False;False;False;False;False;True;True;0;True;_Stencil;255;True;_StencilReadMask;255;True;_StencilWriteMask;0;True;_StencilComp;0;True;_StencilOp;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;2;False;;True;0;True;unity_GUIZTestMode;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=F7D3E31A7A69A7B7ECC67A90A097609181CCC48E
