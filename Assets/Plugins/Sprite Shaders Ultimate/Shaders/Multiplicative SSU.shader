...
Shader "Sprite Shaders Ultimate/Multiplicative SSU"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			float MyCustomExpression16_g11708( float linValue )
			{
			...
			float MyCustomExpression16_g11713( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float MyCustomExpression16_g11750( float linValue )
			{
				#ifdef UNITY_COLORSPACE_GAMMA
				return linValue;
				#else
			...
			float3 MyCustomExpression115_g11760( float3 In, float3 From, float3 To, float Fuzziness, float Range )
			{
			...
			v2f vert( appdata_t IN  )
			{
				...
				#endif
				float2 temp_output_2_0_g11875 = staticSwitch198;
				#ifdef _TOGGLECUSTOMTIME_ON
				...
				float temp_output_8_0_g11875 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g11875 = ( ( sin( ( temp_output_8_0_g11875 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g11875 );
				#else
				float2 staticSwitch4_g11875 = temp_output_2_0_g11875;
				#endif
				#ifdef _ENABLEVIBRATE_ON
				float temp_output_30_0_g11876 = temp_output_8_0_g11875;
				float3 rotatedValue21_g11876 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g11876 * _VibrateRotation ) );
				float2 staticSwitch6_g11875 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g11876 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g11876).xy ) + staticSwitch4_g11875 );
				#else
				float2 staticSwitch6_g11875 = staticSwitch4_g11875;
				#endif
				#ifdef _ENABLESINESCALE_ON
				float2 staticSwitch10_g11875 = ( staticSwitch6_g11875 + ( (IN.vertex.xyz).xy * ( ( ( sin( ( _SineScaleFrequency * temp_output_8_0_g11875 ) ) + 1.0 ) * 0.5 ) * _SineScaleFactor ) ) );
				#else
				float2 staticSwitch10_g11875 = staticSwitch6_g11875;
				#endif
				float2 temp_output_424_0 = staticSwitch10_g11875;
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11711 = tex2Dlod( _FadingMask, float4( uv_FadingMask, 0, 0.0) );
				float temp_output_4_0_g11707 = max( _FadingWidth , 0.001 );
				...
				float2 texCoord23_g11663 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 staticSwitch1_g11663 = (IN.vertex.xyz).xy;
				#elif defined(_SHADERSPACE_OBJECT_SCALED)
				float2 staticSwitch1_g11663 = ( (IN.vertex.xyz).xy * (ase_objectScale).xy );
				...
				float linValue16_g11708 = tex2Dlod( _UberNoiseTexture, float4( ( shaderPosition235 * _FadingNoiseScale ), 0, 0.0) ).r;
				float localMyCustomExpression16_g11708 = MyCustomExpression16_g11708( linValue16_g11708 );
				float clampResult14_g11707 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g11707 ) ) - localMyCustomExpression16_g11708 ) / temp_output_4_0_g11707 ) , 0.0 , 1.0 );
				...
				float staticSwitch139 = ( _FadingFade * ( tex2DNode3_g11711.r * tex2DNode3_g11711.a ) );
				#elif defined(_SHADERFADING_DISSOLVE)
				float staticSwitch139 = clampResult14_g11707;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float linValue16_g11713 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchDistortionSpeed * shaderTime237 ) ) * _GlitchDistortionScale ) ).r;
				float localMyCustomExpression16_g11713 = MyCustomExpression16_g11713( linValue16_g11713 );
				...
				#ifdef _ENABLEGLITCH_ON
				float2 staticSwitch62 = ( staticSwitch59 + ( ( localMyCustomExpression16_g11713 - 0.5 ) * _GlitchDistortion * glitchFade152 ) );
				#else
				float2 staticSwitch62 = staticSwitch59;
				#endif
				float2 temp_output_1_0_g11714 = staticSwitch62;
				float2 temp_output_26_0_g11714 = shaderPosition235;
				float temp_output_25_0_g11714 = shaderTime237;
				float linValue16_g11724 = tex2D( _UberNoiseTexture, ( ( temp_output_26_0_g11714 + ( _UVDistortSpeed * temp_output_25_0_g11714 ) ) * _UVDistortNoiseScale ) ).r;
				float localMyCustomExpression16_g11724 = MyCustomExpression16_g11724( linValue16_g11724 );
				float2 lerpResult21_g11721 = lerp( _UVDistortFrom , _UVDistortTo , localMyCustomExpression16_g11724);
				float2 appendResult2_g11723 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				#ifdef _UVDISTORTMASKTOGGLE_ON
				float2 uv_UVDistortMask = IN.texcoord.xy * _UVDistortMask_ST.xy + _UVDistortMask_ST.zw;
				float4 tex2DNode3_g11722 = tex2D( _UVDistortMask, uv_UVDistortMask );
				float staticSwitch29_g11721 = ( _UVDistortFade * ( tex2DNode3_g11722.r * tex2DNode3_g11722.a ) );
				#else
				float staticSwitch29_g11721 = _UVDistortFade;
				#endif
				#ifdef _ENABLEUVDISTORT_ON
				float2 staticSwitch5_g11714 = ( temp_output_1_0_g11714 + ( lerpResult21_g11721 * ( 100.0 / appendResult2_g11723 ) * staticSwitch29_g11721 ) );
				#else
				float2 staticSwitch5_g11714 = temp_output_1_0_g11714;
				#endif
				#ifdef _ENABLESQUEEZE_ON
				float2 temp_output_1_0_g11720 = staticSwitch5_g11714;
				float2 staticSwitch7_g11714 = ( temp_output_1_0_g11720 + ( ( temp_output_1_0_g11720 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g11720 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g11714 = staticSwitch5_g11714;
				#endif
				#ifdef _ENABLESINEROTATE_ON
				float3 rotatedValue36_g11719 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g11714 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g11714 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				float2 staticSwitch9_g11714 = (rotatedValue36_g11719).xy;
				#else
				float2 staticSwitch9_g11714 = staticSwitch7_g11714;
				#endif
				#ifdef _ENABLEUVROTATE_ON
				float3 rotatedValue8_g11718 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g11714 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g11714 * _UVRotateSpeed * UNITY_PI ) );
				float2 staticSwitch16_g11714 = (rotatedValue8_g11718).xy;
				#else
				float2 staticSwitch16_g11714 = staticSwitch9_g11714;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g11714 = ( ( _UVScrollSpeed * temp_output_25_0_g11714 ) + staticSwitch16_g11714 );
				#else
				float2 staticSwitch14_g11714 = staticSwitch16_g11714;
				#endif
				#ifdef _ENABLEPIXELATE_ON
				float2 appendResult35_g11716 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g11716 = ( ( _PixelatePixelDensity * ( appendResult35_g11716 / _PixelatePixelsPerUnit ) ) * ( 1.0 / max( _PixelateFade , 1E-05 ) ) );
				float2 clampResult46_g11716 = clamp( ( floor( ( MultFactor30_g11716 * ( staticSwitch14_g11714 + ( float2( 0.5,0.5 ) / MultFactor30_g11716 ) ) ) ) / MultFactor30_g11716 ) , float2( 0,0 ) , float2( 1,1 ) );
				float2 staticSwitch4_g11714 = clampResult46_g11716;
				#else
				float2 staticSwitch4_g11714 = staticSwitch14_g11714;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g11714 = ( ( ( staticSwitch4_g11714 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g11714 = staticSwitch4_g11714;
				#endif
				float2 temp_output_1_0_g11725 = staticSwitch24_g11714;
				float temp_output_7_0_g11725 = ( sin( ( _WiggleFrequency * ( temp_output_26_0_g11714.y + ( _WiggleSpeed * temp_output_25_0_g11714 ) ) ) ) * _WiggleOffset * _WiggleFade );
				#ifdef _WIGGLEFIXEDGROUNDTOGGLE_ON
				float staticSwitch18_g11725 = ( temp_output_7_0_g11725 * temp_output_1_0_g11725.y );
				#else
				float staticSwitch18_g11725 = temp_output_7_0_g11725;
				#endif
				#ifdef _ENABLEWIGGLE_ON
				float2 appendResult12_g11725 = (float2(staticSwitch18_g11725 , 0.0));
				float2 staticSwitch13_g11725 = ( temp_output_1_0_g11725 + appendResult12_g11725 );
				#else
				float2 staticSwitch13_g11725 = temp_output_1_0_g11725;
				#endif
				float2 temp_output_484_0 = staticSwitch13_g11725;
				float2 texCoord131 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_FadingMask = IN.texcoord.xy * _FadingMask_ST.xy + _FadingMask_ST.zw;
				float4 tex2DNode3_g11711 = tex2D( _FadingMask, uv_FadingMask );
				float temp_output_4_0_g11707 = max( _FadingWidth , 0.001 );
				float linValue16_g11708 = tex2D( _UberNoiseTexture, ( shaderPosition235 * _FadingNoiseScale ) ).r;
				float localMyCustomExpression16_g11708 = MyCustomExpression16_g11708( linValue16_g11708 );
				float clampResult14_g11707 = clamp( ( ( ( _FadingFade * ( 1.0 + temp_output_4_0_g11707 ) ) - localMyCustomExpression16_g11708 ) / temp_output_4_0_g11707 ) , 0.0 , 1.0 );
				float2 temp_output_27_0_g11709 = shaderPosition235;
				...
				#endif
				#ifdef _SPRITESHEETFIX_ON
				float2 break14_g11726 = staticSwitch485;
				float2 break11_g11726 = float2( 0,0 );
				float2 break10_g11726 = float2( 1,1 );
				float2 break9_g11726 = spriteRectMin376;
				float2 break8_g11726 = spriteRectMax377;
				float2 appendResult15_g11726 = (float2((break9_g11726.x + (break14_g11726.x - break11_g11726.x) * (break8_g11726.x - break9_g11726.x) / (break10_g11726.x - break11_g11726.x)) , (break9_g11726.y + (break14_g11726.y - break11_g11726.y) * (break8_g11726.y - break9_g11726.y) / (break10_g11726.y - break11_g11726.y))));
				float2 staticSwitch371 = min( max( appendResult15_g11726 , spriteRectMin376 ) , spriteRectMax377 );
				#else
				float2 staticSwitch371 = staticSwitch485;
				#endif
				#ifdef _PIXELPERFECTUV_ON
				float2 appendResult7_g11727 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 staticSwitch427 = ( originalUV460 + ( floor( ( ( staticSwitch371 - uvAfterPixelArt450 ) * appendResult7_g11727 ) ) / appendResult7_g11727 ) );
				#else
				float2 staticSwitch427 = staticSwitch371;
				#endif
				float2 finalUV146 = staticSwitch427;
				float2 temp_output_1_0_g11728 = finalUV146;
				#ifdef _ENABLESMOOTHPIXELART_ON
				sampler2D tex3_g11729 = _MainTex;
				float4 textureTexelSize3_g11729 = _MainTex_TexelSize;
				float2 uvs3_g11729 = temp_output_1_0_g11728;
				float4 localtexturePointSmooth3_g11729 = texturePointSmooth( tex3_g11729 , textureTexelSize3_g11729 , uvs3_g11729 );
				float4 staticSwitch8_g11728 = localtexturePointSmooth3_g11729;
				#else
				float4 staticSwitch8_g11728 = tex2D( _MainTex, temp_output_1_0_g11728 );
				#endif
				#ifdef _ENABLEGAUSSIANBLUR_ON
				float temp_output_10_0_g11730 = ( _GaussianBlurOffset * _GaussianBlurFade * 0.005 );
				float temp_output_2_0_g11740 = temp_output_10_0_g11730;
				...
				float2 temp_output_7_0_g11730 = temp_output_1_0_g11728;
				float2 temp_output_1_0_g11740 = ( temp_output_7_0_g11730 + ( temp_output_10_0_g11730 * float2( 1,1 ) ) );
				...
				float temp_output_2_0_g11731 = temp_output_10_0_g11730;
				float2 appendResult16_g11731 = (float2(temp_output_2_0_g11731 , 0.0));
				float2 appendResult25_g11733 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11733 = ( appendResult16_g11731 * appendResult25_g11733 );
				float2 temp_output_1_0_g11731 = ( temp_output_7_0_g11730 + ( temp_output_10_0_g11730 * float2( -1,1 ) ) );
				float2 temp_output_1_0_g11733 = temp_output_1_0_g11731;
				float2 appendResult17_g11731 = (float2(0.0 , temp_output_2_0_g11731));
				float2 appendResult25_g11732 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11732 = ( appendResult17_g11731 * appendResult25_g11732 );
				float2 temp_output_1_0_g11732 = temp_output_1_0_g11731;
				float temp_output_2_0_g11737 = temp_output_10_0_g11730;
				...
				float2 temp_output_1_0_g11737 = ( temp_output_7_0_g11730 + ( temp_output_10_0_g11730 * float2( -1,-1 ) ) );
				...
				float temp_output_2_0_g11734 = temp_output_10_0_g11730;
				float2 appendResult16_g11734 = (float2(temp_output_2_0_g11734 , 0.0));
				float2 appendResult25_g11736 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11736 = ( appendResult16_g11734 * appendResult25_g11736 );
				float2 temp_output_1_0_g11734 = ( temp_output_7_0_g11730 + ( temp_output_10_0_g11730 * float2( 1,-1 ) ) );
				float2 temp_output_1_0_g11736 = temp_output_1_0_g11734;
				float2 appendResult17_g11734 = (float2(0.0 , temp_output_2_0_g11734));
				float2 appendResult25_g11735 = (float2(_MainTex_TexelSize.x , _MainTex_TexelSize.y));
				float2 temp_output_26_0_g11735 = ( appendResult17_g11734 * appendResult25_g11735 );
				float2 temp_output_1_0_g11735 = temp_output_1_0_g11734;
				float4 staticSwitch3_g11728 = ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11742 + temp_output_1_0_g11742 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11741 + temp_output_1_0_g11741 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11733 + temp_output_1_0_g11733 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11733 + temp_output_1_0_g11733 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11732 + temp_output_1_0_g11732 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11732 + temp_output_1_0_g11732 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11739 + temp_output_1_0_g11739 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11739 + temp_output_1_0_g11739 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11738 + temp_output_1_0_g11738 ) ) ) ) + ( ( tex2D( _MainTex, ( temp_output_26_0_g11736 + temp_output_1_0_g11736 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11736 + temp_output_1_0_g11736 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11735 + temp_output_1_0_g11735 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11735 + temp_output_1_0_g11735 ) ) ) ) ) * 0.0625 );
				#else
				float4 staticSwitch3_g11728 = staticSwitch8_g11728;
				#endif
				#ifdef _ENABLESHARPEN_ON
				float2 temp_output_1_0_g11743 = temp_output_1_0_g11728;
				float4 tex2DNode4_g11743 = tex2D( _MainTex, temp_output_1_0_g11743 );
				float temp_output_2_0_g11744 = _SharpenOffset;
				...
				float4 break22_g11743 = ( tex2DNode4_g11743 - ( ( ( ( ( tex2D( _MainTex, ( temp_output_26_0_g11746 + temp_output_1_0_g11746 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11746 + temp_output_1_0_g11746 ) ) ) + ( tex2D( _MainTex, ( temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) + tex2D( _MainTex, ( -temp_output_26_0_g11745 + temp_output_1_0_g11745 ) ) ) ) / 4.0 ) - tex2DNode4_g11743 ) * ( _SharpenFactor * _SharpenFade ) ) );
				float clampResult23_g11743 = clamp( break22_g11743.a , 0.0 , 1.0 );
				float4 appendResult24_g11743 = (float4(break22_g11743.r , break22_g11743.g , break22_g11743.b , clampResult23_g11743));
				float4 staticSwitch12_g11728 = appendResult24_g11743;
				#else
				float4 staticSwitch12_g11728 = staticSwitch3_g11728;
				#endif
				float4 temp_output_471_0 = staticSwitch12_g11728;
				#ifdef _VERTEXTINTFIRST_ON
				float4 temp_output_1_0_g11747 = temp_output_471_0;
				float4 appendResult8_g11747 = (float4(( (temp_output_1_0_g11747).rgb * (IN.color).rgb ) , temp_output_1_0_g11747.a));
				float4 staticSwitch354 = appendResult8_g11747;
				#else
				float4 staticSwitch354 = temp_output_471_0;
				#endif
				float4 originalColor191 = staticSwitch354;
				float4 temp_output_1_0_g11748 = originalColor191;
				float4 temp_output_1_0_g11749 = temp_output_1_0_g11748;
				float2 temp_output_7_0_g11748 = finalUV146;
				float2 temp_output_43_0_g11749 = temp_output_7_0_g11748;
				float2 temp_cast_15 = (_SmokeNoiseScale).xx;
				float linValue16_g11750 = tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g11749 ) * temp_cast_15 ) ).r;
				float localMyCustomExpression16_g11750 = MyCustomExpression16_g11750( linValue16_g11750 );
				float clampResult28_g11749 = clamp( ( ( ( localMyCustomExpression16_g11750 - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g11749 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				#ifdef _ENABLESMOKE_ON
				float3 lerpResult34_g11749 = lerp( (temp_output_1_0_g11749).rgb , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g11749 ) * _SmokeDarkEdge ));
				float4 appendResult31_g11749 = (float4(lerpResult34_g11749 , ( clampResult28_g11749 * _SmokeAlpha * temp_output_1_0_g11749.a )));
				float4 staticSwitch2_g11748 = appendResult31_g11749;
				#else
				float4 staticSwitch2_g11748 = temp_output_1_0_g11748;
				#endif
				#ifdef _ENABLECUSTOMFADE_ON
				float4 temp_output_1_0_g11751 = staticSwitch2_g11748;
				float2 temp_output_57_0_g11751 = temp_output_7_0_g11748;
				float4 tex2DNode3_g11751 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g11751 );
				float linValue16_g11752 = tex2D( _UberNoiseTexture, ( temp_output_57_0_g11751 * _CustomFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11752 = MyCustomExpression16_g11752( linValue16_g11752 );
				float clampResult37_g11751 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g11751.r + ( localMyCustomExpression16_g11752 * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g11751 = (float4((temp_output_1_0_g11751).rgb , ( temp_output_1_0_g11751.a * pow( clampResult37_g11751 , ( _CustomFadeSmoothness / max( tex2DNode3_g11751.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				float4 staticSwitch3_g11748 = appendResult13_g11751;
				#else
				float4 staticSwitch3_g11748 = staticSwitch2_g11748;
				#endif
				float4 temp_output_1_0_g11753 = staticSwitch3_g11748;
				#ifdef _ENABLECHECKERBOARD_ON
				float4 temp_output_1_0_g11754 = temp_output_1_0_g11753;
				float2 appendResult4_g11754 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 temp_output_44_0_g11754 = ( appendResult4_g11754 * _CheckerboardTiling * 0.5 );
				float2 break12_g11754 = step( ( ceil( temp_output_44_0_g11754 ) - temp_output_44_0_g11754 ) , float2( 0.5,0.5 ) );
				float4 appendResult42_g11754 = (float4(( (temp_output_1_0_g11754).rgb * min( ( _CheckerboardDarken + abs( ( -break12_g11754.x + break12_g11754.y ) ) ) , 1.0 ) ) , temp_output_1_0_g11754.a));
				float4 staticSwitch2_g11753 = appendResult42_g11754;
				#else
				float4 staticSwitch2_g11753 = temp_output_1_0_g11753;
				#endif
				float2 temp_output_75_0_g11755 = finalUV146;
				float linValue16_g11756 = tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g11755 ) * _FlameNoiseScale ) ).r;
				float localMyCustomExpression16_g11756 = MyCustomExpression16_g11756( linValue16_g11756 );
				float saferPower57_g11755 = abs( max( ( temp_output_75_0_g11755.y - 0.2 ) , 0.0 ) );
				float temp_output_47_0_g11755 = max( _FlameRadius , 0.01 );
				float clampResult70_g11755 = clamp( ( ( ( localMyCustomExpression16_g11756 * pow( saferPower57_g11755 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g11755 - distance( temp_output_75_0_g11755 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g11755 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				#ifdef _ENABLEFLAME_ON
				float temp_output_63_0_g11755 = ( clampResult70_g11755 * _FlameBrightness );
				float4 appendResult31_g11755 = (float4(temp_output_63_0_g11755 , temp_output_63_0_g11755 , temp_output_63_0_g11755 , clampResult70_g11755));
				float4 staticSwitch6_g11753 = ( appendResult31_g11755 * staticSwitch2_g11753 );
				#else
				float4 staticSwitch6_g11753 = staticSwitch2_g11753;
				#endif
				float4 temp_output_3_0_g11757 = staticSwitch6_g11753;
				float4 temp_output_1_0_g11784 = temp_output_3_0_g11757;
				float2 temp_output_1_0_g11757 = finalUV146;
				#ifdef _RECOLORRGBTEXTURETOGGLE_ON
				float4 staticSwitch81_g11784 = tex2D( _RecolorRGBTexture, temp_output_1_0_g11757 );
				#else
				float4 staticSwitch81_g11784 = temp_output_1_0_g11784;
				#endif
				#ifdef _ENABLERECOLORRGB_ON
				float4 break82_g11784 = staticSwitch81_g11784;
				float temp_output_63_0_g11784 = ( break82_g11784.r + break82_g11784.g + break82_g11784.b );
				float4 break71_g11784 = ( ( _RecolorRGBRedTint * ( break82_g11784.r / temp_output_63_0_g11784 ) ) + ( _RecolorRGBGreenTint * ( break82_g11784.g / temp_output_63_0_g11784 ) ) + ( ( break82_g11784.b / temp_output_63_0_g11784 ) * _RecolorRGBBlueTint ) );
				float3 appendResult56_g11784 = (float3(break71_g11784.r , break71_g11784.g , break71_g11784.b));
				...
				float3 lerpResult26_g11784 = lerp( (temp_output_1_0_g11784).rgb , ( appendResult56_g11784 * pow( saferPower57_g11784 , ( max( break71_g11784.a , 0.01 ) * 2.0 ) ) ) , ( min( ( temp_output_63_0_g11784 * 2.0 ) , 1.0 ) * _RecolorRGBFade ));
				float4 appendResult30_g11784 = (float4(lerpResult26_g11784 , temp_output_1_0_g11784.a));
				float4 staticSwitch43_g11757 = appendResult30_g11784;
				#else
				float4 staticSwitch43_g11757 = temp_output_3_0_g11757;
				#endif
				float4 temp_output_1_0_g11782 = staticSwitch43_g11757;
				#ifdef _RECOLORRGBYCPTEXTURETOGGLE_ON
				float4 staticSwitch62_g11782 = tex2D( _RecolorRGBYCPTexture, temp_output_1_0_g11757 );
				#else
				float4 staticSwitch62_g11782 = temp_output_1_0_g11782;
				#endif
				float3 hsvTorgb33_g11782 = RGBToHSV( staticSwitch62_g11782.rgb );
				float temp_output_43_0_g11782 = ( ( hsvTorgb33_g11782.x + 0.08333334 ) % 1.0 );
				float4 ifLocalVar46_g11782 = 0;
				if( temp_output_43_0_g11782 >= 0.8333333 )
				ifLocalVar46_g11782 = _RecolorRGBYCPPurpleTint;
				else
				ifLocalVar46_g11782 = _RecolorRGBYCPBlueTint;
				float4 ifLocalVar44_g11782 = 0;
				if( temp_output_43_0_g11782 <= 0.6666667 )
				ifLocalVar44_g11782 = _RecolorRGBYCPCyanTint;
				else
				ifLocalVar44_g11782 = ifLocalVar46_g11782;
				float4 ifLocalVar47_g11782 = 0;
				if( temp_output_43_0_g11782 <= 0.3333333 )
				ifLocalVar47_g11782 = _RecolorRGBYCPYellowTint;
				else
				ifLocalVar47_g11782 = _RecolorRGBYCPGreenTint;
				float4 ifLocalVar45_g11782 = 0;
				if( temp_output_43_0_g11782 <= 0.1666667 )
				ifLocalVar45_g11782 = _RecolorRGBYCPRedTint;
				else
				ifLocalVar45_g11782 = ifLocalVar47_g11782;
				float4 ifLocalVar35_g11782 = 0;
				if( temp_output_43_0_g11782 >= 0.5 )
				ifLocalVar35_g11782 = ifLocalVar44_g11782;
				else
				ifLocalVar35_g11782 = ifLocalVar45_g11782;
				#ifdef _ENABLERECOLORRGBYCP_ON
				float4 break55_g11782 = ifLocalVar35_g11782;
				float3 appendResult56_g11782 = (float3(break55_g11782.r , break55_g11782.g , break55_g11782.b));
				float4 break2_g11783 = temp_output_1_0_g11782;
				float saferPower57_g11782 = abs( ( ( break2_g11783.x + break2_g11783.x + break2_g11783.y + break2_g11783.y + break2_g11783.y + break2_g11783.z ) / 6.0 ) );
				float3 lerpResult26_g11782 = lerp( (temp_output_1_0_g11782).rgb , ( appendResult56_g11782 * pow( saferPower57_g11782 , max( ( break55_g11782.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g11782.z * _RecolorRGBYCPFade ));
				float4 appendResult30_g11782 = (float4(lerpResult26_g11782 , temp_output_1_0_g11782.a));
				float4 staticSwitch9_g11757 = appendResult30_g11782;
				#else
				float4 staticSwitch9_g11757 = staticSwitch43_g11757;
				#endif
				#ifdef _ENABLECOLORREPLACE_ON
				float4 temp_output_1_0_g11760 = staticSwitch9_g11757;
				float3 temp_output_2_0_g11760 = (temp_output_1_0_g11760).rgb;
				float3 In115_g11760 = temp_output_2_0_g11760;
				float3 From115_g11760 = (_ColorReplaceFromColor).rgb;
				float4 break2_g11761 = temp_output_1_0_g11760;
				float3 To115_g11760 = ( pow( ( ( break2_g11761.x + break2_g11761.x + break2_g11761.y + break2_g11761.y + break2_g11761.y + break2_g11761.z ) / 6.0 ) , max( _ColorReplaceContrast , 0.0001 ) ) * (_ColorReplaceToColor).rgb );
				float Fuzziness115_g11760 = _ColorReplaceSmoothness;
				float Range115_g11760 = _ColorReplaceRange;
				float3 localMyCustomExpression115_g11760 = MyCustomExpression115_g11760( In115_g11760 , From115_g11760 , To115_g11760 , Fuzziness115_g11760 , Range115_g11760 );
				float3 lerpResult112_g11760 = lerp( temp_output_2_0_g11760 , localMyCustomExpression115_g11760 , _ColorReplaceFade);
				float4 appendResult4_g11760 = (float4(lerpResult112_g11760 , temp_output_1_0_g11760.a));
				float4 staticSwitch29_g11757 = appendResult4_g11760;
				#else
				float4 staticSwitch29_g11757 = staticSwitch9_g11757;
				#endif
				float4 temp_output_1_0_g11771 = staticSwitch29_g11757;
				#ifdef _ENABLENEGATIVE_ON
				float3 temp_output_9_0_g11771 = (temp_output_1_0_g11771).rgb;
				float3 lerpResult3_g11771 = lerp( temp_output_9_0_g11771 , ( 1.0 - temp_output_9_0_g11771 ) , _NegativeFade);
				float4 appendResult8_g11771 = (float4(lerpResult3_g11771 , temp_output_1_0_g11771.a));
				float4 staticSwitch4_g11771 = appendResult8_g11771;
				#else
				float4 staticSwitch4_g11771 = temp_output_1_0_g11771;
				#endif
				float4 temp_output_57_0_g11757 = staticSwitch4_g11771;
				#ifdef _ENABLECONTRAST_ON
				float4 temp_output_1_0_g11792 = temp_output_57_0_g11757;
				float3 saferPower5_g11792 = abs( (temp_output_1_0_g11792).rgb );
				float3 temp_cast_29 = (_Contrast).xxx;
				float4 appendResult4_g11792 = (float4(pow( saferPower5_g11792 , temp_cast_29 ) , temp_output_1_0_g11792.a));
				float4 staticSwitch32_g11757 = appendResult4_g11792;
				#else
				float4 staticSwitch32_g11757 = temp_output_57_0_g11757;
				#endif
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 temp_output_2_0_g11769 = staticSwitch32_g11757;
				float4 appendResult6_g11769 = (float4(( (temp_output_2_0_g11769).rgb * _Brightness ) , temp_output_2_0_g11769.a));
				float4 staticSwitch33_g11757 = appendResult6_g11769;
				#else
				float4 staticSwitch33_g11757 = staticSwitch32_g11757;
				#endif
				#ifdef _ENABLEHUE_ON
				float4 temp_output_2_0_g11770 = staticSwitch33_g11757;
				float3 hsvTorgb1_g11770 = RGBToHSV( temp_output_2_0_g11770.rgb );
				float3 hsvTorgb3_g11770 = HSVToRGB( float3(( hsvTorgb1_g11770.x + _Hue ),hsvTorgb1_g11770.y,hsvTorgb1_g11770.z) );
				float4 appendResult8_g11770 = (float4(hsvTorgb3_g11770 , temp_output_2_0_g11770.a));
				float4 staticSwitch36_g11757 = appendResult8_g11770;
				#else
				float4 staticSwitch36_g11757 = staticSwitch33_g11757;
				#endif
				#ifdef _ENABLESPLITTONING_ON
				float4 temp_output_1_0_g11786 = staticSwitch36_g11757;
				float4 break2_g11787 = temp_output_1_0_g11786;
				float temp_output_3_0_g11786 = ( ( break2_g11787.x + break2_g11787.x + break2_g11787.y + break2_g11787.y + break2_g11787.y + break2_g11787.z ) / 6.0 );
				float clampResult25_g11786 = clamp( ( ( ( ( temp_output_3_0_g11786 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g11786 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g11786);
				float temp_output_9_0_g11788 = max( _SplitToningContrast , 0.0 );
				float saferPower7_g11788 = abs( ( temp_output_3_0_g11786 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11788 ) , 0.0 ) ) ) );
				float3 lerpResult11_g11786 = lerp( (temp_output_1_0_g11786).rgb , ( lerpResult6_g11786 * pow( saferPower7_g11788 , temp_output_9_0_g11788 ) ) , _SplitToningFade);
				float4 appendResult18_g11786 = (float4(lerpResult11_g11786 , temp_output_1_0_g11786.a));
				float4 staticSwitch30_g11757 = appendResult18_g11786;
				#else
				float4 staticSwitch30_g11757 = staticSwitch36_g11757;
				#endif
				#ifdef _ENABLEBLACKTINT_ON
				float4 temp_output_1_0_g11767 = staticSwitch30_g11757;
				float3 temp_output_4_0_g11767 = (temp_output_1_0_g11767).rgb;
				float4 break12_g11767 = temp_output_1_0_g11767;
				float3 lerpResult7_g11767 = lerp( temp_output_4_0_g11767 , ( temp_output_4_0_g11767 + (_BlackTintColor).rgb ) , pow( ( 1.0 - min( max( max( break12_g11767.r , break12_g11767.g ) , break12_g11767.b ) , 1.0 ) ) , max( _BlackTintPower , 0.001 ) ));
				float3 lerpResult13_g11767 = lerp( temp_output_4_0_g11767 , lerpResult7_g11767 , _BlackTintFade);
				float4 appendResult11_g11767 = (float4(lerpResult13_g11767 , break12_g11767.a));
				float4 staticSwitch20_g11757 = appendResult11_g11767;
				#else
				float4 staticSwitch20_g11757 = staticSwitch30_g11757;
				#endif
				#ifdef _ENABLEINKSPREAD_ON
				float4 temp_output_1_0_g11778 = staticSwitch20_g11757;
				float4 break2_g11780 = temp_output_1_0_g11778;
				float temp_output_9_0_g11781 = max( _InkSpreadContrast , 0.0 );
				float saferPower7_g11781 = abs( ( ( ( break2_g11780.x + break2_g11780.x + break2_g11780.y + break2_g11780.y + break2_g11780.y + break2_g11780.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11781 ) , 0.0 ) ) ) );
				float2 temp_output_65_0_g11778 = shaderPosition235;
				float linValue16_g11779 = tex2D( _UberNoiseTexture, ( temp_output_65_0_g11778 * _InkSpreadNoiseScale ) ).r;
				float localMyCustomExpression16_g11779 = MyCustomExpression16_g11779( linValue16_g11779 );
				float clampResult53_g11778 = clamp( ( ( ( _InkSpreadDistance - distance( _InkSpreadPosition , temp_output_65_0_g11778 ) ) + ( localMyCustomExpression16_g11779 * _InkSpreadNoiseFactor ) ) / max( _InkSpreadWidth , 0.001 ) ) , 0.0 , 1.0 );
				float3 lerpResult7_g11778 = lerp( (temp_output_1_0_g11778).rgb , ( (_InkSpreadColor).rgb * pow( saferPower7_g11781 , temp_output_9_0_g11781 ) ) , ( _InkSpreadFade * clampResult53_g11778 ));
				float4 appendResult9_g11778 = (float4(lerpResult7_g11778 , (temp_output_1_0_g11778).a));
				float4 staticSwitch17_g11757 = appendResult9_g11778;
				#else
				float4 staticSwitch17_g11757 = staticSwitch20_g11757;
				#endif
				float temp_output_39_0_g11757 = shaderTime237;
				#ifdef _ENABLESHIFTHUE_ON
				float4 temp_output_1_0_g11772 = staticSwitch17_g11757;
				float3 hsvTorgb15_g11772 = RGBToHSV( (temp_output_1_0_g11772).rgb );
				float3 hsvTorgb19_g11772 = HSVToRGB( float3(( ( temp_output_39_0_g11757 * _ShiftHueSpeed ) + hsvTorgb15_g11772.x ),hsvTorgb15_g11772.y,hsvTorgb15_g11772.z) );
				float4 appendResult6_g11772 = (float4(hsvTorgb19_g11772 , temp_output_1_0_g11772.a));
				float4 staticSwitch19_g11757 = appendResult6_g11772;
				#else
				float4 staticSwitch19_g11757 = staticSwitch17_g11757;
				#endif
				float3 hsvTorgb19_g11775 = HSVToRGB( float3(( ( temp_output_39_0_g11757 * _AddHueSpeed ) % 1.0 ),_AddHueSaturation,_AddHueBrightness) );
				float4 temp_output_1_0_g11775 = staticSwitch19_g11757;
				float4 break2_g11777 = temp_output_1_0_g11775;
				float saferPower27_g11775 = abs( ( ( break2_g11777.x + break2_g11777.x + break2_g11777.y + break2_g11777.y + break2_g11777.y + break2_g11777.z ) / 6.0 ) );
				#ifdef _ADDHUEMASKTOGGLE_ON
				float2 uv_AddHueMask = IN.texcoord.xy * _AddHueMask_ST.xy + _AddHueMask_ST.zw;
				float4 tex2DNode3_g11776 = tex2D( _AddHueMask, uv_AddHueMask );
				float staticSwitch33_g11775 = ( _AddHueFade * ( tex2DNode3_g11776.r * tex2DNode3_g11776.a ) );
				#else
				float staticSwitch33_g11775 = _AddHueFade;
				#endif
				#ifdef _ENABLEADDHUE_ON
				float4 appendResult6_g11775 = (float4(( ( hsvTorgb19_g11775 * pow( saferPower27_g11775 , max( _AddHueContrast , 0.001 ) ) * staticSwitch33_g11775 ) + (temp_output_1_0_g11775).rgb ) , temp_output_1_0_g11775.a));
				float4 staticSwitch23_g11757 = appendResult6_g11775;
				#else
				float4 staticSwitch23_g11757 = staticSwitch19_g11757;
				#endif
				float4 temp_output_1_0_g11773 = staticSwitch23_g11757;
				float4 break2_g11774 = temp_output_1_0_g11773;
				float3 temp_output_13_0_g11773 = (_SineGlowColor).rgb;
				#ifdef _SINEGLOWMASKTOGGLE_ON
				float2 uv_SineGlowMask = IN.texcoord.xy * _SineGlowMask_ST.xy + _SineGlowMask_ST.zw;
				float4 tex2DNode30_g11773 = tex2D( _SineGlowMask, uv_SineGlowMask );
				float3 staticSwitch27_g11773 = ( (tex2DNode30_g11773).rgb * temp_output_13_0_g11773 * tex2DNode30_g11773.a );
				#else
				float3 staticSwitch27_g11773 = temp_output_13_0_g11773;
				#endif
				#ifdef _ENABLESINEGLOW_ON
				float4 appendResult21_g11773 = (float4(( (temp_output_1_0_g11773).rgb + ( pow( ( ( break2_g11774.x + break2_g11774.x + break2_g11774.y + break2_g11774.y + break2_g11774.y + break2_g11774.z ) / 6.0 ) , max( _SineGlowContrast , 0.0 ) ) * staticSwitch27_g11773 * _SineGlowFade * ( ( ( sin( ( temp_output_39_0_g11757 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g11773.a));
				float4 staticSwitch28_g11757 = appendResult21_g11773;
				#else
				float4 staticSwitch28_g11757 = staticSwitch23_g11757;
				#endif
				#ifdef _ENABLESATURATION_ON
				float4 temp_output_1_0_g11762 = staticSwitch28_g11757;
				float4 break2_g11763 = temp_output_1_0_g11762;
				float3 temp_cast_45 = (( ( break2_g11763.x + break2_g11763.x + break2_g11763.y + break2_g11763.y + break2_g11763.y + break2_g11763.z ) / 6.0 )).xxx;
				float3 lerpResult5_g11762 = lerp( temp_cast_45 , (temp_output_1_0_g11762).rgb , _Saturation);
				float4 appendResult8_g11762 = (float4(lerpResult5_g11762 , temp_output_1_0_g11762.a));
				float4 staticSwitch38_g11757 = appendResult8_g11762;
				#else
				float4 staticSwitch38_g11757 = staticSwitch28_g11757;
				#endif
				float4 temp_output_15_0_g11764 = staticSwitch38_g11757;
				float3 temp_output_82_0_g11764 = (_InnerOutlineColor).rgb;
				float2 temp_output_7_0_g11764 = temp_output_1_0_g11757;
				float temp_output_179_0_g11764 = temp_output_39_0_g11757;
				#ifdef _INNEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch187_g11764 = ( (tex2D( _InnerOutlineTintTexture, ( temp_output_7_0_g11764 + ( _InnerOutlineTextureSpeed * temp_output_179_0_g11764 ) ) )).rgb * temp_output_82_0_g11764 );
				#else
				float3 staticSwitch187_g11764 = temp_output_82_0_g11764;
				#endif
				#ifdef _INNEROUTLINEDISTORTIONTOGGLE_ON
				float linValue16_g11766 = tex2D( _UberNoiseTexture, ( ( ( temp_output_179_0_g11764 * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g11764 ) * _InnerOutlineNoiseScale ) ).r;
				float localMyCustomExpression16_g11766 = MyCustomExpression16_g11766( linValue16_g11766 );
				float2 staticSwitch169_g11764 = ( ( localMyCustomExpression16_g11766 - 0.5 ) * _InnerOutlineDistortionIntensity );
				#else
				float2 staticSwitch169_g11764 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11764 = ( staticSwitch169_g11764 + temp_output_7_0_g11764 );
				float2 appendResult2_g11765 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g11764 = ( 100.0 / appendResult2_g11765 );
				float temp_output_178_0_g11764 = ( _InnerOutlineFade * ( 1.0 - min( min( min( min( min( min( min( tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11764 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11764 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11764 + ( ( _InnerOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11764 ) ) ).a ) ) );
				float3 lerpResult176_g11764 = lerp( (temp_output_15_0_g11764).rgb , staticSwitch187_g11764 , temp_output_178_0_g11764);
				#ifdef _INNEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch188_g11764 = ( temp_output_178_0_g11764 * temp_output_15_0_g11764.a );
				#else
				float staticSwitch188_g11764 = temp_output_15_0_g11764.a;
				#endif
				#ifdef _ENABLEINNEROUTLINE_ON
				float4 appendResult177_g11764 = (float4(lerpResult176_g11764 , staticSwitch188_g11764));
				float4 staticSwitch12_g11757 = appendResult177_g11764;
				#else
				float4 staticSwitch12_g11757 = staticSwitch38_g11757;
				#endif
				float4 temp_output_15_0_g11789 = staticSwitch12_g11757;
				float3 temp_output_82_0_g11789 = (_OuterOutlineColor).rgb;
				float2 temp_output_7_0_g11789 = temp_output_1_0_g11757;
				float temp_output_186_0_g11789 = temp_output_39_0_g11757;
				#ifdef _OUTEROUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11789 = ( (tex2D( _OuterOutlineTintTexture, ( temp_output_7_0_g11789 + ( _OuterOutlineTextureSpeed * temp_output_186_0_g11789 ) ) )).rgb * temp_output_82_0_g11789 );
				#else
				float3 staticSwitch199_g11789 = temp_output_82_0_g11789;
				#endif
				float temp_output_182_0_g11789 = ( ( 1.0 - temp_output_15_0_g11789.a ) * min( ( _OuterOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11789 = 1.0;
				#else
				float staticSwitch203_g11789 = temp_output_182_0_g11789;
				#endif
				float3 lerpResult178_g11789 = lerp( (temp_output_15_0_g11789).rgb , staticSwitch199_g11789 , staticSwitch203_g11789);
				float3 lerpResult170_g11789 = lerp( lerpResult178_g11789 , staticSwitch199_g11789 , staticSwitch203_g11789);
				#ifdef _OUTEROUTLINEDISTORTIONTOGGLE_ON
				float linValue16_g11790 = tex2D( _UberNoiseTexture, ( ( ( temp_output_186_0_g11789 * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g11789 ) * _OuterOutlineNoiseScale ) ).r;
				float localMyCustomExpression16_g11790 = MyCustomExpression16_g11790( linValue16_g11790 );
				float2 staticSwitch157_g11789 = ( ( localMyCustomExpression16_g11790 - 0.5 ) * _OuterOutlineDistortionIntensity );
				#else
				float2 staticSwitch157_g11789 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g11789 = ( staticSwitch157_g11789 + temp_output_7_0_g11789 );
				float2 appendResult2_g11791 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g11789 = ( 100.0 / appendResult2_g11791 );
				float lerpResult168_g11789 = lerp( temp_output_15_0_g11789.a , min( ( max( max( max( max( max( max( max( tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g11789 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g11789 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g11789 + ( ( _OuterOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g11789 ) ) ).a ) * 3.0 ) , 1.0 ) , _OuterOutlineFade);
				#ifdef _OUTEROUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11789 = ( temp_output_182_0_g11789 * lerpResult168_g11789 );
				#else
				float staticSwitch200_g11789 = lerpResult168_g11789;
				#endif
				#ifdef _ENABLEOUTEROUTLINE_ON
				float4 appendResult174_g11789 = (float4(lerpResult170_g11789 , staticSwitch200_g11789));
				float4 staticSwitch13_g11757 = appendResult174_g11789;
				#else
				float4 staticSwitch13_g11757 = staticSwitch12_g11757;
				#endif
				float4 temp_output_15_0_g11768 = staticSwitch13_g11757;
				float3 temp_output_82_0_g11768 = (_PixelOutlineColor).rgb;
				float2 temp_output_7_0_g11768 = temp_output_1_0_g11757;
				#ifdef _PIXELOUTLINETEXTURETOGGLE_ON
				float3 staticSwitch199_g11768 = ( (tex2D( _PixelOutlineTintTexture, ( temp_output_7_0_g11768 + ( _PixelOutlineTextureSpeed * temp_output_39_0_g11757 ) ) )).rgb * temp_output_82_0_g11768 );
				#else
				float3 staticSwitch199_g11768 = temp_output_82_0_g11768;
				#endif
				float temp_output_182_0_g11768 = ( ( 1.0 - temp_output_15_0_g11768.a ) * min( ( _PixelOutlineFade * 3.0 ) , 1.0 ) );
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch203_g11768 = 1.0;
				#else
				float staticSwitch203_g11768 = temp_output_182_0_g11768;
				#endif
				float3 lerpResult178_g11768 = lerp( (temp_output_15_0_g11768).rgb , staticSwitch199_g11768 , staticSwitch203_g11768);
				float3 lerpResult170_g11768 = lerp( lerpResult178_g11768 , staticSwitch199_g11768 , staticSwitch203_g11768);
				float2 appendResult206_g11768 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_209_0_g11768 = ( float2( 1,1 ) / appendResult206_g11768 );
				float lerpResult168_g11768 = lerp( temp_output_15_0_g11768.a , min( ( max( max( max( tex2D( _MainTex, ( temp_output_7_0_g11768 + ( ( _PixelOutlineWidth * float2( 0,-1 ) ) * temp_output_209_0_g11768 ) ) ).a , tex2D( _MainTex, ( temp_output_7_0_g11768 + ( ( _PixelOutlineWidth * float2( 0,1 ) ) * temp_output_209_0_g11768 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11768 + ( ( _PixelOutlineWidth * float2( -1,0 ) ) * temp_output_209_0_g11768 ) ) ).a ) , tex2D( _MainTex, ( temp_output_7_0_g11768 + ( ( _PixelOutlineWidth * float2( 1,0 ) ) * temp_output_209_0_g11768 ) ) ).a ) * 3.0 ) , 1.0 ) , _PixelOutlineFade);
				#ifdef _PIXELOUTLINEOUTLINEONLYTOGGLE_ON
				float staticSwitch200_g11768 = ( temp_output_182_0_g11768 * lerpResult168_g11768 );
				#else
				float staticSwitch200_g11768 = lerpResult168_g11768;
				#endif
				#ifdef _ENABLEPIXELOUTLINE_ON
				float4 appendResult174_g11768 = (float4(lerpResult170_g11768 , staticSwitch200_g11768));
				float4 staticSwitch48_g11757 = appendResult174_g11768;
				#else
				float4 staticSwitch48_g11757 = staticSwitch13_g11757;
				#endif
				#ifdef _ENABLEPINGPONGGLOW_ON
				float3 lerpResult15_g11758 = lerp( (_PingPongGlowFrom).rgb , (_PingPongGlowTo).rgb , ( ( sin( ( temp_output_39_0_g11757 * _PingPongGlowFrequency ) ) + 1.0 ) / 2.0 ));
				float4 temp_output_5_0_g11758 = staticSwitch48_g11757;
				float4 break2_g11759 = temp_output_5_0_g11758;
				float4 appendResult12_g11758 = (float4(( ( lerpResult15_g11758 * _PingPongGlowFade * pow( ( ( break2_g11759.x + break2_g11759.x + break2_g11759.y + break2_g11759.y + break2_g11759.y + break2_g11759.z ) / 6.0 ) , max( _PingPongGlowContrast , 0.0 ) ) ) + (temp_output_5_0_g11758).rgb ) , temp_output_5_0_g11758.a));
				float4 staticSwitch46_g11757 = appendResult12_g11758;
				#else
				float4 staticSwitch46_g11757 = staticSwitch48_g11757;
				#endif
				float4 temp_output_361_0 = staticSwitch46_g11757;
				#ifdef _ENABLEHOLOGRAM_ON
				float4 temp_output_1_0_g11793 = temp_output_361_0;
				float4 break2_g11794 = temp_output_1_0_g11793;
				float temp_output_9_0_g11795 = max( _HologramContrast , 0.0 );
				float saferPower7_g11795 = abs( ( ( ( break2_g11794.x + break2_g11794.x + break2_g11794.y + break2_g11794.y + break2_g11794.y + break2_g11794.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11795 ) , 0.0 ) ) ) );
				float4 appendResult22_g11793 = (float4(( (_HologramTint).rgb * pow( saferPower7_g11795 , temp_output_9_0_g11795 ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g11793.a )));
				float4 lerpResult37_g11793 = lerp( temp_output_1_0_g11793 , appendResult22_g11793 , hologramFade182);
				float4 staticSwitch56 = lerpResult37_g11793;
				#else
				float4 staticSwitch56 = temp_output_361_0;
				#endif
				#ifdef _ENABLEGLITCH_ON
				float4 temp_output_1_0_g11796 = staticSwitch56;
				float4 break2_g11798 = temp_output_1_0_g11796;
				float temp_output_34_0_g11796 = shaderTime237;
				float linValue16_g11797 = tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchNoiseSpeed * temp_output_34_0_g11796 ) ) * _GlitchNoiseScale ) ).r;
				float localMyCustomExpression16_g11797 = MyCustomExpression16_g11797( linValue16_g11797 );
				float3 hsvTorgb3_g11799 = HSVToRGB( float3(( localMyCustomExpression16_g11797 + ( temp_output_34_0_g11796 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g11796 = lerp( (temp_output_1_0_g11796).rgb , ( ( ( break2_g11798.x + break2_g11798.x + break2_g11798.y + break2_g11798.y + break2_g11798.y + break2_g11798.z ) / 6.0 ) * _GlitchBrightness * hsvTorgb3_g11799 ) , glitchFade152);
				float4 appendResult27_g11796 = (float4(lerpResult23_g11796 , temp_output_1_0_g11796.a));
				float4 staticSwitch57 = appendResult27_g11796;
				#else
				float4 staticSwitch57 = staticSwitch56;
				#endif
				float4 temp_output_3_0_g11800 = staticSwitch57;
				float4 temp_output_1_0_g11825 = temp_output_3_0_g11800;
				float2 temp_output_41_0_g11800 = shaderPosition235;
				float2 temp_output_99_0_g11825 = temp_output_41_0_g11800;
				float temp_output_40_0_g11800 = shaderTime237;
				#ifdef _CAMOUFLAGEANIMATIONTOGGLE_ON
				float linValue16_g11830 = tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g11800 * _CamouflageDistortionSpeed ) + temp_output_99_0_g11825 ) * _CamouflageDistortionScale ) ).r;
				float localMyCustomExpression16_g11830 = MyCustomExpression16_g11830( linValue16_g11830 );
				float2 staticSwitch101_g11825 = ( ( ( localMyCustomExpression16_g11830 - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g11825 );
				#else
				float2 staticSwitch101_g11825 = temp_output_99_0_g11825;
				#endif
				float linValue16_g11827 = tex2D( _UberNoiseTexture, ( staticSwitch101_g11825 * _CamouflageNoiseScaleA ) ).r;
				float localMyCustomExpression16_g11827 = MyCustomExpression16_g11827( linValue16_g11827 );
				float clampResult52_g11825 = clamp( ( ( _CamouflageDensityA - localMyCustomExpression16_g11827 ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g11825 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g11825 ) , clampResult52_g11825);
				float linValue16_g11829 = tex2D( _UberNoiseTexture, ( ( staticSwitch101_g11825 + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r;
				#ifdef _ENABLECAMOUFLAGE_ON
				float localMyCustomExpression16_g11829 = MyCustomExpression16_g11829( linValue16_g11829 );
				float clampResult65_g11825 = clamp( ( ( _CamouflageDensityB - localMyCustomExpression16_g11829 ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g11825 = lerp( lerpResult55_g11825 , ( _CamouflageColorB * clampResult65_g11825 ) , clampResult65_g11825);
				float4 break2_g11828 = temp_output_1_0_g11825;
				float temp_output_9_0_g11826 = max( _CamouflageContrast , 0.0 );
				float saferPower7_g11826 = abs( ( ( ( break2_g11828.x + break2_g11828.x + break2_g11828.y + break2_g11828.y + break2_g11828.y + break2_g11828.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11826 ) , 0.0 ) ) ) );
				float3 lerpResult4_g11825 = lerp( (temp_output_1_0_g11825).rgb , ( (lerpResult68_g11825).rgb * pow( saferPower7_g11826 , temp_output_9_0_g11826 ) ) , _CamouflageFade);
				float4 appendResult7_g11825 = (float4(lerpResult4_g11825 , temp_output_1_0_g11825.a));
				float4 staticSwitch26_g11800 = appendResult7_g11825;
				#else
				float4 staticSwitch26_g11800 = temp_output_3_0_g11800;
				#endif
				float4 temp_output_1_0_g11819 = staticSwitch26_g11800;
				float temp_output_59_0_g11819 = temp_output_40_0_g11800;
				float2 temp_output_58_0_g11819 = temp_output_41_0_g11800;
				float linValue16_g11820 = tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g11819 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g11819 ) * _MetalNoiseDistortionScale ) ).r;
				float localMyCustomExpression16_g11820 = MyCustomExpression16_g11820( linValue16_g11820 );
				float linValue16_g11822 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11820 - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g11819 * _MetalNoiseSpeed ) + temp_output_58_0_g11819 ) ) * _MetalNoiseScale ) ).r;
				...
				float temp_output_5_0_g11819 = ( ( break2_g11821.x + break2_g11821.x + break2_g11821.y + break2_g11821.y + break2_g11821.y + break2_g11821.z ) / 6.0 );
				float temp_output_9_0_g11823 = max( _MetalHighlightContrast , 0.0 );
				float saferPower7_g11823 = abs( ( temp_output_5_0_g11819 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11823 ) , 0.0 ) ) ) );
				float saferPower2_g11819 = abs( temp_output_5_0_g11819 );
				#ifdef _METALMASKTOGGLE_ON
				float2 uv_MetalMask = IN.texcoord.xy * _MetalMask_ST.xy + _MetalMask_ST.zw;
				float4 tex2DNode3_g11824 = tex2D( _MetalMask, uv_MetalMask );
				float staticSwitch60_g11819 = ( _MetalFade * ( tex2DNode3_g11824.r * tex2DNode3_g11824.a ) );
				#else
				float staticSwitch60_g11819 = _MetalFade;
				#endif
				#ifdef _ENABLEMETAL_ON
				float4 lerpResult45_g11819 = lerp( temp_output_1_0_g11819 , ( ( max( ( ( _MetalHighlightDensity - localMyCustomExpression16_g11822 ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( saferPower7_g11823 , temp_output_9_0_g11823 ) ) + ( pow( saferPower2_g11819 , _MetalContrast ) * _MetalColor ) ) , staticSwitch60_g11819);
				float4 appendResult8_g11819 = (float4((lerpResult45_g11819).rgb , (temp_output_1_0_g11819).a));
				float4 staticSwitch28_g11800 = appendResult8_g11819;
				#else
				float4 staticSwitch28_g11800 = staticSwitch26_g11800;
				#endif
				#ifdef _ENABLEFROZEN_ON
				float4 temp_output_1_0_g11813 = staticSwitch28_g11800;
				float4 break2_g11814 = temp_output_1_0_g11813;
				float temp_output_7_0_g11813 = ( ( break2_g11814.x + break2_g11814.x + break2_g11814.y + break2_g11814.y + break2_g11814.y + break2_g11814.z ) / 6.0 );
				float temp_output_9_0_g11816 = max( _FrozenContrast , 0.0 );
				float saferPower7_g11816 = abs( ( temp_output_7_0_g11813 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11816 ) , 0.0 ) ) ) );
				float saferPower20_g11813 = abs( temp_output_7_0_g11813 );
				float2 temp_output_72_0_g11813 = temp_output_41_0_g11800;
				float linValue16_g11815 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11813 * _FrozenSnowScale ) ).r;
				float localMyCustomExpression16_g11815 = MyCustomExpression16_g11815( linValue16_g11815 );
				float temp_output_73_0_g11813 = temp_output_40_0_g11800;
				float linValue16_g11817 = tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g11813 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g11813 ) * _FrozenHighlightDistortionScale ) ).r;
				float localMyCustomExpression16_g11817 = MyCustomExpression16_g11817( linValue16_g11817 );
				float linValue16_g11818 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11817 - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g11813 * _FrozenHighlightSpeed ) + temp_output_72_0_g11813 ) ) * _FrozenHighlightScale ) ).r;
				float localMyCustomExpression16_g11818 = MyCustomExpression16_g11818( linValue16_g11818 );
				float saferPower42_g11813 = abs( temp_output_7_0_g11813 );
				float3 lerpResult57_g11813 = lerp( (temp_output_1_0_g11813).rgb , ( ( pow( saferPower7_g11816 , temp_output_9_0_g11816 ) * (_FrozenTint).rgb ) + ( pow( saferPower20_g11813 , _FrozenSnowContrast ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - localMyCustomExpression16_g11815 ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - localMyCustomExpression16_g11818 ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( saferPower42_g11813 , _FrozenHighlightContrast ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g11813 = (float4(lerpResult57_g11813 , temp_output_1_0_g11813.a));
				float4 staticSwitch29_g11800 = appendResult26_g11813;
				#else
				float4 staticSwitch29_g11800 = staticSwitch28_g11800;
				#endif
				float4 temp_output_1_0_g11808 = staticSwitch29_g11800;
				float3 temp_output_28_0_g11808 = (temp_output_1_0_g11808).rgb;
				float4 break2_g11812 = float4( temp_output_28_0_g11808 , 0.0 );
				float saferPower21_g11808 = abs( ( ( break2_g11812.x + break2_g11812.x + break2_g11812.y + break2_g11812.y + break2_g11812.y + break2_g11812.z ) / 6.0 ) );
				float2 temp_output_72_0_g11808 = temp_output_41_0_g11800;
				float linValue16_g11811 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11808 * _BurnSwirlNoiseScale ) ).r;
				float localMyCustomExpression16_g11811 = MyCustomExpression16_g11811( linValue16_g11811 );
				float linValue16_g11809 = tex2D( _UberNoiseTexture, ( ( ( ( localMyCustomExpression16_g11811 - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g11808 ) * _BurnInsideNoiseScale ) ).r;
				#ifdef _ENABLEBURN_ON
				float localMyCustomExpression16_g11809 = MyCustomExpression16_g11809( linValue16_g11809 );
				float clampResult68_g11808 = clamp( ( _BurnInsideNoiseFactor - localMyCustomExpression16_g11809 ) , 0.0 , 1.0 );
				float linValue16_g11810 = tex2D( _UberNoiseTexture, ( temp_output_72_0_g11808 * _BurnEdgeNoiseScale ) ).r;
				float localMyCustomExpression16_g11810 = MyCustomExpression16_g11810( linValue16_g11810 );
				float temp_output_15_0_g11808 = ( ( ( _BurnRadius - distance( temp_output_72_0_g11808 , _BurnPosition ) ) + ( localMyCustomExpression16_g11810 * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g11808 = clamp( temp_output_15_0_g11808 , 0.0 , 1.0 );
				float3 lerpResult29_g11808 = lerp( temp_output_28_0_g11808 , ( pow( saferPower21_g11808 , max( _BurnInsideContrast , 0.001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g11808 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g11808);
				float3 lerpResult40_g11808 = lerp( temp_output_28_0_g11808 , ( lerpResult29_g11808 + ( ( step( temp_output_15_0_g11808 , 1.0 ) * step( 0.0 , temp_output_15_0_g11808 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g11808 = (float4(lerpResult40_g11808 , temp_output_1_0_g11808.a));
				float4 staticSwitch32_g11800 = appendResult43_g11808;
				#else
				float4 staticSwitch32_g11800 = staticSwitch29_g11800;
				#endif
				#ifdef _ENABLERAINBOW_ON
				float2 temp_output_42_0_g11804 = temp_output_41_0_g11800;
				float linValue16_g11805 = tex2D( _UberNoiseTexture, ( temp_output_42_0_g11804 * _RainbowNoiseScale ) ).r;
				float localMyCustomExpression16_g11805 = MyCustomExpression16_g11805( linValue16_g11805 );
				float3 hsvTorgb3_g11807 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g11804 , _RainbowCenter ) + ( localMyCustomExpression16_g11805 * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g11800 ) ),1.0,1.0) );
				float3 hsvTorgb36_g11804 = RGBToHSV( hsvTorgb3_g11807 );
				float3 hsvTorgb37_g11804 = HSVToRGB( float3(hsvTorgb36_g11804.x,_RainbowSaturation,( hsvTorgb36_g11804.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g11804 = staticSwitch32_g11800;
				float4 break2_g11806 = temp_output_1_0_g11804;
				float saferPower24_g11804 = abs( ( ( break2_g11806.x + break2_g11806.x + break2_g11806.y + break2_g11806.y + break2_g11806.y + break2_g11806.z ) / 6.0 ) );
				float4 appendResult29_g11804 = (float4(( ( hsvTorgb37_g11804 * pow( saferPower24_g11804 , max( _RainbowContrast , 0.001 ) ) * _RainbowFade ) + (temp_output_1_0_g11804).rgb ) , temp_output_1_0_g11804.a));
				float4 staticSwitch34_g11800 = appendResult29_g11804;
				#else
				float4 staticSwitch34_g11800 = staticSwitch32_g11800;
				#endif
				float4 temp_output_1_0_g11801 = staticSwitch34_g11800;
				float3 temp_output_57_0_g11801 = (temp_output_1_0_g11801).rgb;
				float4 break2_g11802 = temp_output_1_0_g11801;
				float3 temp_cast_68 = (( ( break2_g11802.x + break2_g11802.x + break2_g11802.y + break2_g11802.y + break2_g11802.y + break2_g11802.z ) / 6.0 )).xxx;
				float3 lerpResult92_g11801 = lerp( temp_cast_68 , temp_output_57_0_g11801 , _ShineSaturation);
				float3 saferPower83_g11801 = abs( lerpResult92_g11801 );
				float3 temp_cast_69 = (max( _ShineContrast , 0.001 )).xxx;
				float3 rotatedValue69_g11801 = RotateAroundAxis( float3( 0,0,0 ), float3( ( _ShineFrequency * temp_output_41_0_g11800 ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 180.0 ) * UNITY_PI ) );
				float temp_output_103_0_g11801 = ( _ShineFrequency * _ShineWidth );
				float clampResult80_g11801 = clamp( ( ( sin( ( rotatedValue69_g11801.x - ( temp_output_40_0_g11800 * _ShineSpeed * _ShineFrequency ) ) ) - ( 1.0 - temp_output_103_0_g11801 ) ) / temp_output_103_0_g11801 ) , 0.0 , 1.0 );
				#ifdef _SHINEMASKTOGGLE_ON
				float2 uv_ShineMask = IN.texcoord.xy * _ShineMask_ST.xy + _ShineMask_ST.zw;
				float4 tex2DNode3_g11803 = tex2D( _ShineMask, uv_ShineMask );
				float staticSwitch98_g11801 = ( _ShineFade * ( tex2DNode3_g11803.r * tex2DNode3_g11803.a ) );
				#else
				float staticSwitch98_g11801 = _ShineFade;
				#endif
				#ifdef _ENABLESHINE_ON
				float4 appendResult8_g11801 = (float4(( temp_output_57_0_g11801 + ( ( pow( saferPower83_g11801 , temp_cast_69 ) * (_ShineColor).rgb ) * clampResult80_g11801 * staticSwitch98_g11801 ) ) , (temp_output_1_0_g11801).a));
				float4 staticSwitch36_g11800 = appendResult8_g11801;
				#else
				float4 staticSwitch36_g11800 = staticSwitch34_g11800;
				#endif
				#ifdef _ENABLEPOISON_ON
				float temp_output_41_0_g11831 = temp_output_40_0_g11800;
				float linValue16_g11833 = tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g11831 * _PoisonNoiseSpeed ) + temp_output_41_0_g11800 ) * _PoisonNoiseScale ) ).r;
				float localMyCustomExpression16_g11833 = MyCustomExpression16_g11833( linValue16_g11833 );
				float saferPower19_g11831 = abs( abs( ( ( ( localMyCustomExpression16_g11833 + ( temp_output_41_0_g11831 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) );
				float3 temp_output_24_0_g11831 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g11831 = staticSwitch36_g11800;
				float3 temp_output_28_0_g11831 = (temp_output_1_0_g11831).rgb;
				float4 break2_g11832 = float4( temp_output_28_0_g11831 , 0.0 );
				float3 lerpResult32_g11831 = lerp( temp_output_28_0_g11831 , ( temp_output_24_0_g11831 * ( ( break2_g11832.x + break2_g11832.x + break2_g11832.y + break2_g11832.y + break2_g11832.y + break2_g11832.z ) / 6.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g11831 = (float4(( ( max( pow( saferPower19_g11831 , _PoisonDensity ) , 0.0 ) * temp_output_24_0_g11831 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g11831 ) , temp_output_1_0_g11831.a));
				float4 staticSwitch39_g11800 = appendResult27_g11831;
				#else
				float4 staticSwitch39_g11800 = staticSwitch36_g11800;
				#endif
				float4 temp_output_10_0_g11834 = staticSwitch39_g11800;
				float3 temp_output_12_0_g11834 = (temp_output_10_0_g11834).rgb;
				float2 temp_output_2_0_g11834 = temp_output_41_0_g11800;
				float temp_output_1_0_g11834 = temp_output_40_0_g11800;
				float2 temp_output_6_0_g11834 = ( temp_output_1_0_g11834 * _EnchantedSpeed );
				float linValue16_g11837 = tex2D( _UberNoiseTexture, ( ( ( temp_output_2_0_g11834 - ( ( temp_output_6_0_g11834 + float2( 1.234,5.6789 ) ) * float2( 0.95,1.05 ) ) ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11837 = MyCustomExpression16_g11837( linValue16_g11837 );
				float linValue16_g11835 = tex2D( _UberNoiseTexture, ( ( ( temp_output_6_0_g11834 + temp_output_2_0_g11834 ) * _EnchantedScale ) * float2( 1,1 ) ) ).r;
				float localMyCustomExpression16_g11835 = MyCustomExpression16_g11835( linValue16_g11835 );
				float temp_output_36_0_g11834 = ( localMyCustomExpression16_g11837 + localMyCustomExpression16_g11835 );
				float temp_output_43_0_g11834 = ( temp_output_36_0_g11834 * 0.5 );
				float3 lerpResult42_g11834 = lerp( (_EnchantedLowColor).rgb , (_EnchantedHighColor).rgb , temp_output_43_0_g11834);
				#ifdef _ENCHANTEDRAINBOWTOGGLE_ON
				float3 hsvTorgb53_g11834 = HSVToRGB( float3(( ( temp_output_43_0_g11834 * _EnchantedRainbowDensity ) + ( _EnchantedRainbowSpeed * temp_output_1_0_g11834 ) ),_EnchantedRainbowSaturation,1.0) );
				float3 staticSwitch50_g11834 = hsvTorgb53_g11834;
				#else
				float3 staticSwitch50_g11834 = lerpResult42_g11834;
				#endif
				float4 break2_g11836 = temp_output_10_0_g11834;
				float saferPower24_g11834 = abs( ( ( break2_g11836.x + break2_g11836.x + break2_g11836.y + break2_g11836.y + break2_g11836.y + break2_g11836.z ) / 6.0 ) );
				float3 temp_output_40_0_g11834 = ( staticSwitch50_g11834 * pow( saferPower24_g11834 , _EnchantedContrast ) * _EnchantedBrightness );
				float temp_output_45_0_g11834 = ( max( ( temp_output_36_0_g11834 - _EnchantedReduce ) , 0.0 ) * _EnchantedFade );
				#ifdef _ENCHANTEDLERPTOGGLE_ON
				float3 lerpResult44_g11834 = lerp( temp_output_12_0_g11834 , temp_output_40_0_g11834 , temp_output_45_0_g11834);
				float3 staticSwitch47_g11834 = lerpResult44_g11834;
				#else
				float3 staticSwitch47_g11834 = ( temp_output_12_0_g11834 + ( temp_output_40_0_g11834 * temp_output_45_0_g11834 ) );
				#endif
				#ifdef _ENABLEENCHANTED_ON
				float4 appendResult19_g11834 = (float4(staticSwitch47_g11834 , temp_output_10_0_g11834.a));
				float4 staticSwitch11_g11834 = appendResult19_g11834;
				#else
				float4 staticSwitch11_g11834 = temp_output_10_0_g11834;
				#endif
				float4 temp_output_1_0_g11838 = staticSwitch11_g11834;
				float4 break5_g11838 = temp_output_1_0_g11838;
				float3 appendResult32_g11838 = (float3(break5_g11838.r , break5_g11838.g , break5_g11838.b));
				float4 break2_g11839 = temp_output_1_0_g11838;
				float temp_output_4_0_g11838 = ( ( break2_g11839.x + break2_g11839.x + break2_g11839.y + break2_g11839.y + break2_g11839.y + break2_g11839.z ) / 6.0 );
				float temp_output_11_0_g11838 = ( ( ( temp_output_4_0_g11838 + ( temp_output_40_0_g11800 * _ShiftingSpeed ) ) * _ShiftingDensity ) % 1.0 );
				float3 lerpResult20_g11838 = lerp( (_ShiftingColorA).rgb , (_ShiftingColorB).rgb , ( abs( ( temp_output_11_0_g11838 - 0.5 ) ) * 2.0 ));
				#ifdef _SHIFTINGRAINBOWTOGGLE_ON
				float3 hsvTorgb12_g11838 = HSVToRGB( float3(temp_output_11_0_g11838,_ShiftingSaturation,_ShiftingBrightness) );
				float3 staticSwitch26_g11838 = hsvTorgb12_g11838;
				#else
				float3 staticSwitch26_g11838 = ( lerpResult20_g11838 * _ShiftingBrightness );
				#endif
				#ifdef _ENABLESHIFTING_ON
				float3 lerpResult31_g11838 = lerp( appendResult32_g11838 , ( staticSwitch26_g11838 * pow( temp_output_4_0_g11838 , _ShiftingContrast ) ) , _ShiftingFade);
				float4 appendResult6_g11838 = (float4(lerpResult31_g11838 , break5_g11838.a));
				float4 staticSwitch33_g11838 = appendResult6_g11838;
				#else
				float4 staticSwitch33_g11838 = temp_output_1_0_g11838;
				#endif
				float4 temp_output_473_0 = staticSwitch33_g11838;
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 break4_g11840 = temp_output_473_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g11840 = (float4(break4_g11840.r , break4_g11840.g , break4_g11840.b , ( break4_g11840.a * fullDistortionAlpha164 )));
				float4 staticSwitch77 = appendResult5_g11840;
				#else
				float4 staticSwitch77 = temp_output_473_0;
				#endif
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 break4_g11841 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g11669 ) ):( clampResult154_g11669 ));
				float4 appendResult5_g11841 = (float4(break4_g11841.r , break4_g11841.g , break4_g11841.b , ( break4_g11841.a * directionalDistortionAlpha167 )));
				float4 staticSwitch75 = appendResult5_g11841;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g11842 = staticSwitch75;
				float4 temp_output_1_0_g11843 = temp_output_1_0_g11842;
				float temp_output_53_0_g11843 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g11842 = shaderPosition235;
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float linValue16_g11844 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11842 * _FullAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11844 = MyCustomExpression16_g11844( linValue16_g11844 );
				float clampResult17_g11843 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g11843 ) ) - localMyCustomExpression16_g11844 ) / temp_output_53_0_g11843 ) , 0.0 , 1.0 );
				float4 appendResult3_g11843 = (float4((temp_output_1_0_g11843).rgb , ( temp_output_1_0_g11843.a * clampResult17_g11843 )));
				float4 staticSwitch3_g11842 = appendResult3_g11843;
				#else
				float4 staticSwitch3_g11842 = temp_output_1_0_g11842;
				#endif
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float linValue16_g11852 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g11842 * _FullGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11852 = MyCustomExpression16_g11852( linValue16_g11852 );
				float temp_output_5_0_g11851 = localMyCustomExpression16_g11852;
				float temp_output_61_0_g11851 = step( temp_output_5_0_g11851 , _FullGlowDissolveFade );
				float temp_output_53_0_g11851 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g11851 = staticSwitch3_g11842;
				float4 appendResult3_g11851 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g11851 - step( temp_output_5_0_g11851 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g11851 ) ) - temp_output_53_0_g11851 ) ) ) ) + (temp_output_1_0_g11851).rgb ) , ( temp_output_1_0_g11851.a * temp_output_61_0_g11851 )));
				float4 staticSwitch5_g11842 = appendResult3_g11851;
				#else
				float4 staticSwitch5_g11842 = staticSwitch3_g11842;
				#endif
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 temp_output_1_0_g11853 = staticSwitch5_g11842;
				float2 temp_output_76_0_g11853 = temp_output_18_0_g11842;
				float linValue16_g11854 = tex2D( _UberNoiseTexture, ( temp_output_76_0_g11853 * _SourceAlphaDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11854 = MyCustomExpression16_g11854( linValue16_g11854 );
				float clampResult17_g11853 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g11853 ) + ( localMyCustomExpression16_g11854 * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11853 = (float4((temp_output_1_0_g11853).rgb , ( temp_output_1_0_g11853.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g11853 ) ):( clampResult17_g11853 )) )));
				float4 staticSwitch8_g11842 = appendResult3_g11853;
				#else
				float4 staticSwitch8_g11842 = staticSwitch5_g11842;
				#endif
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float2 temp_output_90_0_g11849 = temp_output_18_0_g11842;
				float linValue16_g11850 = tex2D( _UberNoiseTexture, ( temp_output_90_0_g11849 * _SourceGlowDissolveNoiseScale ) ).r;
				float localMyCustomExpression16_g11850 = MyCustomExpression16_g11850( linValue16_g11850 );
				float temp_output_65_0_g11849 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g11849 ) + ( localMyCustomExpression16_g11850 * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g11849 = step( temp_output_65_0_g11849 , _SourceGlowDissolveFade );
				float temp_output_76_0_g11849 = step( temp_output_65_0_g11849 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g11849 = staticSwitch8_g11842;
				float4 appendResult3_g11849 = (float4(( ( max( ( temp_output_75_0_g11849 - temp_output_76_0_g11849 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g11849).rgb ) , ( temp_output_1_0_g11849.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g11849 ) ):( temp_output_75_0_g11849 )) )));
				float4 staticSwitch9_g11842 = appendResult3_g11849;
				#else
				float4 staticSwitch9_g11842 = staticSwitch8_g11842;
				#endif
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 temp_output_1_0_g11845 = staticSwitch9_g11842;
				float2 temp_output_161_0_g11845 = temp_output_18_0_g11842;
				float3 rotatedValue136_g11845 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g11845 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11845 = rotatedValue136_g11845;
				float linValue16_g11846 = tex2D( _UberNoiseTexture, ( temp_output_161_0_g11845 * _DirectionalAlphaFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11846 = MyCustomExpression16_g11846( linValue16_g11846 );
				float clampResult154_g11845 = clamp( ( ( break130_g11845.x + break130_g11845.y + _DirectionalAlphaFadeFade + ( localMyCustomExpression16_g11846 * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11845 = (float4((temp_output_1_0_g11845).rgb , ( temp_output_1_0_g11845.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g11845 ) ):( clampResult154_g11845 )) )));
				float4 staticSwitch11_g11842 = appendResult3_g11845;
				#else
				float4 staticSwitch11_g11842 = staticSwitch9_g11842;
				#endif
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float2 temp_output_171_0_g11847 = temp_output_18_0_g11842;
				float3 rotatedValue136_g11847 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g11847 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 180.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g11847 = rotatedValue136_g11847;
				float linValue16_g11848 = tex2D( _UberNoiseTexture, ( temp_output_171_0_g11847 * _DirectionalGlowFadeNoiseScale ) ).r;
				float localMyCustomExpression16_g11848 = MyCustomExpression16_g11848( linValue16_g11848 );
				float temp_output_168_0_g11847 = max( ( ( break130_g11847.x + break130_g11847.y + _DirectionalGlowFadeFade + ( localMyCustomExpression16_g11848 * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g11847 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11847 ) ):( temp_output_168_0_g11847 )) );
				float4 temp_output_1_0_g11847 = staticSwitch11_g11842;
				float clampResult154_g11847 = clamp( temp_output_161_0_g11847 , 0.0 , 1.0 );
				float4 appendResult3_g11847 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g11847 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g11847 ) ):( temp_output_168_0_g11847 )) ) ) ) + (temp_output_1_0_g11847).rgb ) , ( temp_output_1_0_g11847.a * clampResult154_g11847 )));
				float4 staticSwitch15_g11842 = appendResult3_g11847;
				#else
				float4 staticSwitch15_g11842 = staticSwitch11_g11842;
				#endif
				float4 temp_output_1_0_g11855 = staticSwitch15_g11842;
				float2 temp_output_126_0_g11855 = temp_output_18_0_g11842;
				float temp_output_121_0_g11855 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g11855 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g11856 = (float2(temp_output_121_0_g11855 , temp_output_121_0_g11855));
				float temp_output_17_0_g11856 = length( ( (( ( abs( temp_output_126_0_g11855 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g11856 ) );
				#ifdef _ENABLEHALFTONE_ON
				float clampResult17_g11855 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g11856 ) / fwidth( temp_output_17_0_g11856 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g11855 = (float4((temp_output_1_0_g11855).rgb , ( temp_output_1_0_g11855.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g11855 ) ):( clampResult17_g11855 )) )));
				float4 staticSwitch13_g11842 = appendResult3_g11855;
				#else
				float4 staticSwitch13_g11842 = staticSwitch15_g11842;
				#endif
				float3 temp_output_3_0_g11858 = (_AddColorColor).rgb;
				#ifdef _ADDCOLORMASKTOGGLE_ON
				float2 uv_AddColorMask = IN.texcoord.xy * _AddColorMask_ST.xy + _AddColorMask_ST.zw;
				float4 tex2DNode19_g11858 = tex2D( _AddColorMask, uv_AddColorMask );
				float3 staticSwitch16_g11858 = ( temp_output_3_0_g11858 * ( (tex2DNode19_g11858).rgb * tex2DNode19_g11858.a ) );
				#else
				float3 staticSwitch16_g11858 = temp_output_3_0_g11858;
				#endif
				float4 temp_output_1_0_g11858 = staticSwitch13_g11842;
				#ifdef _ADDCOLORCONTRASTTOGGLE_ON
				float4 break2_g11860 = temp_output_1_0_g11858;
				float temp_output_9_0_g11859 = max( _AddColorContrast , 0.0 );
				float saferPower7_g11859 = abs( ( ( ( break2_g11860.x + break2_g11860.x + break2_g11860.y + break2_g11860.y + break2_g11860.y + break2_g11860.z ) / 6.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g11859 ) , 0.0 ) ) ) );
				float3 staticSwitch17_g11858 = ( staticSwitch16_g11858 * pow( saferPower7_g11859 , temp_output_9_0_g11859 ) );
				#else
				float3 staticSwitch17_g11858 = staticSwitch16_g11858;
				#endif
				#ifdef _ENABLEADDCOLOR_ON
				float4 appendResult6_g11858 = (float4(( ( staticSwitch17_g11858 * _AddColorFade ) + (temp_output_1_0_g11858).rgb ) , temp_output_1_0_g11858.a));
				float4 staticSwitch5_g11857 = appendResult6_g11858;
				#else
				float4 staticSwitch5_g11857 = staticSwitch13_g11842;
				#endif
				#ifdef _ENABLEALPHATINT_ON
				float4 temp_output_1_0_g11861 = staticSwitch5_g11857;
				float3 lerpResult4_g11861 = lerp( (temp_output_1_0_g11861).rgb , (_AlphaTintColor).rgb , ( ( 1.0 - temp_output_1_0_g11861.a ) * step( _AlphaTintMinAlpha , temp_output_1_0_g11861.a ) * _AlphaTintFade ));
				float4 appendResult13_g11861 = (float4(lerpResult4_g11861 , temp_output_1_0_g11861.a));
				float4 staticSwitch11_g11857 = appendResult13_g11861;
				#else
				float4 staticSwitch11_g11857 = staticSwitch5_g11857;
				#endif
				float4 temp_output_1_0_g11862 = staticSwitch11_g11857;
				float3 temp_output_6_0_g11862 = (_StrongTintTint).rgb;
				#ifdef _STRONGTINTMASKTOGGLE_ON
				float2 uv_StrongTintMask = IN.texcoord.xy * _StrongTintMask_ST.xy + _StrongTintMask_ST.zw;
				float4 tex2DNode23_g11862 = tex2D( _StrongTintMask, uv_StrongTintMask );
				float3 staticSwitch21_g11862 = ( temp_output_6_0_g11862 * ( (tex2DNode23_g11862).rgb * tex2DNode23_g11862.a ) );
				#else
				float3 staticSwitch21_g11862 = temp_output_6_0_g11862;
				#endif
				#ifdef _STRONGTINTCONTRASTTOGGLE_ON
				float4 break2_g11864 = temp_output_1_0_g11862;
				float temp_output_9_0_g11863 = max( _StrongTintContrast , 0.0 );
				...
				float3 staticSwitch22_g11862 = ( pow( saferPower7_g11863 , temp_output_9_0_g11863 ) * staticSwitch21_g11862 );
				#else
				float3 staticSwitch22_g11862 = staticSwitch21_g11862;
				#endif
				#ifdef _ENABLESTRONGTINT_ON
				float3 lerpResult7_g11862 = lerp( (temp_output_1_0_g11862).rgb , staticSwitch22_g11862 , _StrongTintFade);
				float4 appendResult9_g11862 = (float4(lerpResult7_g11862 , (temp_output_1_0_g11862).a));
				float4 staticSwitch7_g11857 = appendResult9_g11862;
				#else
				float4 staticSwitch7_g11857 = staticSwitch11_g11857;
				#endif
				float4 temp_output_2_0_g11865 = staticSwitch7_g11857;
				#ifdef _ENABLESHADOW_ON
				float4 break4_g11867 = temp_output_2_0_g11865;
				float3 appendResult5_g11867 = (float3(break4_g11867.r , break4_g11867.g , break4_g11867.b));
				float2 appendResult2_g11866 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float4 appendResult85_g11865 = (float4(_ShadowColor.r , _ShadowColor.g , _ShadowColor.b , ( _ShadowFade * tex2D( _MainTex, ( finalUV146 - ( ( 100.0 / appendResult2_g11866 ) * _ShadowOffset ) ) ).a )));
				float4 break6_g11867 = appendResult85_g11865;
				float3 appendResult7_g11867 = (float3(break6_g11867.r , break6_g11867.g , break6_g11867.b));
				float temp_output_11_0_g11867 = ( ( 1.0 - break4_g11867.a ) * break6_g11867.a );
				float temp_output_32_0_g11867 = ( break4_g11867.a + temp_output_11_0_g11867 );
				float4 appendResult18_g11867 = (float4(( ( ( appendResult5_g11867 * break4_g11867.a ) + ( appendResult7_g11867 * temp_output_11_0_g11867 ) ) * ( 1.0 / max( temp_output_32_0_g11867 , 0.01 ) ) ) , temp_output_32_0_g11867));
				float4 staticSwitch82_g11865 = appendResult18_g11867;
				#else
				float4 staticSwitch82_g11865 = temp_output_2_0_g11865;
				#endif
				float4 break4_g11869 = staticSwitch82_g11865;
				#ifdef _ENABLECUSTOMFADE_ON
				float staticSwitch8_g11748 = 1.0;
				#else
				float staticSwitch8_g11748 = IN.color.a;
				#endif
				#ifdef _ENABLESMOKE_ON
				float staticSwitch9_g11748 = 1.0;
				#else
				float staticSwitch9_g11748 = staticSwitch8_g11748;
				#endif
				float customVertexAlpha193 = staticSwitch9_g11748;
				...
				float4 appendResult8_g11870 = (float4(( (temp_output_1_0_g11870).rgb * (IN.color).rgb ) , temp_output_1_0_g11870.a));
				#ifdef _VERTEXTINTFIRST_ON
				...
				float4 staticSwitch143 = staticSwitch342;
				#endif
				float4 temp_output_7_0_g11873 = staticSwitch143;
				#ifdef _BAKEDMATERIAL_ON
				float4 appendResult2_g11873 = (float4(( (temp_output_7_0_g11873).rgb / max( temp_output_7_0_g11873.a , 1E-05 ) ) , temp_output_7_0_g11873.a));
				float4 staticSwitch6_g11873 = appendResult2_g11873;
				#else
				float4 staticSwitch6_g11873 = temp_output_7_0_g11873;
				#endif
				float4 temp_output_340_0 = staticSwitch6_g11873;
...
/*ASEBEGIN
Version=19002
248;166;1837;1046;-5454.688;507.8461;1.277686;True;False
...
Node;AmplifyShaderEditor.FunctionNode;439;3389.449,1182.896;Inherit;False;ShaderSpace;8;;11663;be729ef05db9c224caec82a3516038dc;0;2;61;FLOAT2;0,0;False;3;SAMPLER2D;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;365;-372.9774,-3275.82;Inherit;False;_UberInteractive;492;;11664;f8a4d7008519ad249b29e4a9381f963f;0;2;9;FLOAT;0;False;3;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;79;-47.4363,-2946.944;Inherit;False;_FullDistortion;426;;11666;62960fe27c1c398408207bb462ffd10e;0;3;195;FLOAT2;0,0;False;160;FLOAT2;0,0;False;194;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;81;747.3577,-2918.135;Inherit;False;_DirectionalDistortion;414;;11669;30e6ac39427ee11419083602d572972f;0;3;182;FLOAT2;0,0;False;160;FLOAT2;0,0;False;181;SAMPLER2D;;False;2;FLOAT2;174;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;102;919.0109,-667.4209;Inherit;False;_GlitchPre;209;;11672;b8ad29d751d87bd4d9cbf14898be6163;0;3;19;FLOAT;0;False;18;FLOAT2;0,0;False;16;SAMPLER2D;;False;2;FLOAT;15;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;52;1839.482,-2552.931;Inherit;False;_HologramUV;202;;11674;7c71b1b031ffcbe48805e17b94671163;0;5;77;FLOAT;0;False;55;FLOAT;0;False;76;SAMPLER2D;;False;37;FLOAT2;0,0;False;39;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;292;5091.561,1459.408;Inherit;False;ShaderMasker;-1;;11711;3d25b55dbfdd24f48b9bd371bdde0e97;0;2;1;FLOAT;0;False;2;SAMPLER2D;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;223;4905.316,1828.167;Inherit;False;_UberDissolveFade;-1;;11707;cb957eb9b67f4f243aa8ba0547208263;0;5;21;FLOAT2;0,0;False;1;FLOAT;0;False;16;SAMPLER2D;0;False;18;FLOAT2;0,0;False;20;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;221;;11712;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;484;3382.41,-2373.518;Inherit;False;_UberTransformUV;431;;11714;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;378;5475.994,-2043.135;Inherit;False;Remap2D;-1;;11726;f79f855c0a5c94649b58f3d8127375ae;0;5;13;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;1,1;False;5;FLOAT2;0,0;False;6;FLOAT2;1,1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;470;6618.802,-2035.91;Inherit;False;_PixelArtUV_2;-1;;11727;4b65626ba2313ca40a96813b19044794;0;4;21;FLOAT2;0,0;False;17;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;471;-1990.589,-315.832;Inherit;False;_UberSample;530;;11728;1028d755b36e2b04da25c3b882a2e2ec;0;2;1;FLOAT2;0,0;False;2;SAMPLER2D;;False;1;COLOR;0
Node;AmplifyShaderEditor.VertexColorNode;358;-1921.027,-115.7738;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;356;-1686.027,-106.7738;Inherit;False;ColorMultiply;-1;;11747;1f51da7edd80c06488c56d28bc096dec;0;2;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;343;-737.796,35.8288;Inherit;False;_UberCustomAlpha;541;;11748;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;FLOAT;12;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;515;;11753;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;361;-136.8644,-329.1863;Inherit;False;_UberColor;60;;11757;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-37.83691,-91.99512;Inherit;False;182;hologramFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;195;;11793;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;215;;11796;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;473;1656.25,-345.9998;Inherit;False;_UberEffect;226;;11800;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;78;2104.106,-267.8359;Inherit;False;AlphaMultiply;-1;;11840;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;76;3014.405,-219.2272;Inherit;False;AlphaMultiply;-1;;11841;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;354;;11842;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;478;4200.417,-206.2577;Inherit;False;_UberColorFinal;33;;11857;6ac57aba23ea6404ba71b6806ea93971;0;3;14;FLOAT2;0,0;False;15;SAMPLER2D;;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4877.096,136.7432;Inherit;False;TintVertex;-1;;11871;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;510;;11874;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;340;6010.595,-19.64009;Inherit;False;BakingHandler;6;;11873;f63dfe0dc7c747c43b593d357b168fa0;0;1;7;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;424;4759.72,401.6135;Inherit;False;_UberTransformOffset;476;;11875;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;14;7231.972,58.59605;Float;False;True;-1;2;SpriteShadersUltimate.SSUShaderGUI;0;8;Sprite Shaders Ultimate/Multiplicative SSU;0f8ba0101102bb14ebf021ddadce9b49;True;SubShader 0 Pass 0;0;0;SubShader 0 Pass 0;2;True;True;6;2;False;;0;False;;3;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;True;5;Queue=Transparent=Queue=0;IgnoreProjector=True;RenderType=Transparent=RenderType;PreviewType=Plane;CanUseSpriteAtlas=True;False;False;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;0;;0;0;Standard;0;0;1;True;False;;False;0
...
ASEEND*/
//CHKSM=BC554B1740AF034ACB888306683701A2B0C5FC7D
